...
এই আর্টিকেলে আমরা তথাকথিত **প্রুফার কোড** (বা প্রুফার সিকোয়েন্স) দেখব, যা একটি লেবেলযুক্ত ট্রিকে অনন্যভাবে সংখ্যার একটি সিকোয়েন্সে এনকোড করার একটি পদ্ধতি।

প্রুফার কোডের সাহায্যে আমরা **কেইলির সূত্র** প্রুফ করব (যা একটি কমপ্লিট গ্রাফে স্প্যানিং ট্রির সংখ্যা নির্দিষ্ট করে)।
এছাড়াও আমরা একটি গ্রাফকে সংযুক্ত করতে এজ যোগ করার উপায়ের সংখ্যা গণনার সমস্যার সমাধান দেখাব।

**দ্রষ্টব্য**, আমরা একক ভার্টেক্স নিয়ে গঠিত ট্রি কনসিডার করব না - এটি একটি বিশেষ ক্ষেত্র যেখানে একাধিক স্টেটমেন্ট সাংঘর্ষিক হয়।
...
আবিষ্কারক - হাইন্‌ৎস প্রুফার - ১৯১৮ সালে কেইলির সূত্রের প্রুফ হিসেবে এই কোড প্রস্তাব করেন।

### একটা দেওয়া ট্রির জন্য প্রুফার কোড নির্মাণ

প্রুফার কোড এভাবে নির্মাণ করা হয়।
আমরা নিচের প্রক্রিয়াটি $n - 2$ বার পুনরাবৃত্তি করব:
...
সুতরাং একটা দেওয়া ট্রির জন্য প্রুফার কোড হলো $n - 2$টি সংখ্যার একটি সিকোয়েন্স, যেখানে প্রতিটি সংখ্যা সংযুক্ত ভার্টেক্সের নম্বর, অর্থাৎ এই সংখ্যা $[0, n-1]$ ব্যবধানে।
...
### লিনিয়ার সময়ে একটা দেওয়া ট্রির জন্য প্রুফার কোড নির্মাণ
...
### প্রুফার কোড ব্যবহার করে ট্রি রিকভার

ট্রি রিকভার করতে শুধু শেষ অংশে আলোচিত বৈশিষ্ট্যের উপর ফোকাস করাই যথেষ্ট।
...
নিচের ইমপ্লিমেন্টেশনটি ট্রির সাথে সংশ্লিষ্ট এজের তালিকা রিটার্ন করে।
...
### লিনিয়ার সময়ে প্রুফার কোড ব্যবহার করে ট্রি রিকভার
...
এবং প্রতিটি প্রুফার কোডের জন্য আমরা মূল ট্রি রিকভার করতে পারি।
...
এই সূত্রের একাধিক প্রুফ আছে।
প্রুফার কোডের ধারণা ব্যবহার করলে এই স্টেটমেন্ট কোনো আশ্চর্যের বিষয় নয়।

আসলে, $[0; n-1]$ ব্যবধান থেকে $n-2$টি সংখ্যা বিশিষ্ট যেকোনো প্রুফার কোড $n$টি ভার্টেক্সের কোনো ট্রির সাথে সম্পর্কিত।
...
আমরা $k-1$টি এজ যোগ করার উপায়ের সংখ্যা গণনা করতে চাই যেন গ্রাফটি কানেক্টেড হয় (স্পষ্টতই $k-1$ হলো গ্রাফকে কানেক্টেড করতে প্রয়োজনীয় ন্যূনতম সংখ্যা)।

চলো এই সমস্যা সমাধানের জন্য একটি সূত্র বের করি।

আমরা গ্রাফের কানেক্টেড কম্পোনেন্টগুলোর আকারের জন্য $s_1, \dots, s_k$ ব্যবহার করি।
আমরা একটি কানেক্টেড কম্পোনেন্টের মধ্যে এজ যোগ করতে পারি না।
...
ধরো ভার্টেক্সগুলো সংযুক্ত করার পর ট্রিতে $d_1, \dots, d_k$ হলো ভার্টেক্সগুলোর ডিগ্রি।
...
বর্তমানে এটি সত্যিই ভয়ংকর উত্তর মনে হচ্ছে, তবে আমরা **মাল্টিনোমিয়াল থিওরেম** ব্যবহার করতে পারি, যা বলে:
...
মাল্টিনোমিয়াল থিওরেম প্রয়োগ করার পর আমরা **সমস্যার উত্তর** পাই:
