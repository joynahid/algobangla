...
এই ক্ষেত্রে আমরা প্রকৃতপক্ষে স্ট্রিং $s[i \dots n-1] + s[0 \dots j]$ অর্থ করি।
অতিরিক্তভাবে আমরা $s$ এর দৈর্ঘ্যের মডুলো সমস্ত সূচক নেব, এবং সহজতার জন্য মডুলো অপারেশন বাদ দেব।

আমরা যে অ্যালগরিদম আলোচনা করি তা $\lceil \log n \rceil + 1$ পুনরাবৃত্তি সম্পাদন করবে।
$k$-তম পুনরাবৃত্তিতে ($k = 0 \dots \lceil \log n \rceil$) আমরা $s$ এর দৈর্ঘ্য $2^k$ এর $n$ চক্রীয় সাবস্ট্রিং সাজাই।
$\lceil \log n \rceil$-তম পুনরাবৃত্তির পরে দৈর্ঘ্য $2^{\lceil \log n \rceil} \ge n$ এর সাবস্ট্রিংগুলি সাজানো হবে, তাই এটি চক্রীয় পরিবর্তন একসাথে সাজানোর সমতুল্য।

অ্যালগরিদমের প্রতিটি পুনরাবৃত্তিতে, পারমুটেশন $p[0 \dots n-1]$ ছাড়াও, যেখানে $p[i]$ হল সাজানো ক্রমে $i$-তম সাবস্ট্রিং ($i$ থেকে শুরু করে এবং দৈর্ঘ্য $2^k$) এর সূচক, আমরা একটি অ্যারে $c[0 \dots n-1]$ ও বজায় রাখব, যেখানে $c[i]$ **সমতুল্য শ্রেণী** এর সাথে সামঞ্জস্যপূর্ণ যাতে সাবস্ট্রিং অন্তর্গত।
...
উদাহরণস্বরূপ $0$-তম পুনরাবৃত্তিতে অ্যারেটি $p = (3,~ 1,~ 0,~ 2)$ বা $p = (3,~ 0,~ 1,~ 2)$ ও হতে পারত।
...
প্রথমে আপনাকে $i$ এবং $j$ থেকে শুরু হওয়া দুটি ব্লক তুলনা করতে হবে, এবং যদি এগুলি সমান হয় তবে অবস্থান $i + l - 1$ এবং $j + l - 1$ এ শেষ হওয়া দুটি ব্লক তুলনা করুন:
