...
তোমাকে $n$ দৈর্ঘ্যের একটি স্ট্রিং $s$ দেওয়া আছে।
এই স্ট্রিং-এর **প্রিফিক্স ফাংশন** হলো $n$ দৈর্ঘ্যের একটি অ্যারে $\pi$ হিসেবে ডিফাইন করা, যেখানে $\pi[i]$ হলো সাবস্ট্রিং $s[0 \dots i]$-এর দীর্ঘতম প্রকৃত প্রিফিক্সের দৈর্ঘ্য যেটা এই সাবস্ট্রিং-এর সাফিক্সও।
একটি স্ট্রিং-এর প্রকৃত প্রিফিক্স হলো এমন প্রিফিক্স যা স্ট্রিং নিজেই নয়।
সংজ্ঞা অনুযায়ী, $\pi[0] = 0$।

গাণিতিকভাবে প্রিফিক্স ফাংশনের সংজ্ঞা এভাবে লেখা যায়:
...
প্রিফিক্স ফাংশনের সংজ্ঞা হুবহু ফলো করে এমন অ্যালগরিদম এরকম:
...
এটা একটি সাবস্ট্রিং সার্চ অ্যালগরিদমের মূল ফাংশন হিসেবে ব্যবহৃত হয়েছিল।

### প্রথম অপটিমাইজেশন

প্রথম গুরুত্বপূর্ণ পর্যবেক্ষণ হলো, প্রিফিক্স ফাংশনের মান সর্বাধিক এক বাড়তে পারে।

আসলে, অন্যথায় যদি $\pi[i + 1] \gt \pi[i] + 1$ হয়, তাহলে আমরা $\pi[i + 1]$ দৈর্ঘ্যের $i + 1$ অবস্থানে শেষ হওয়া এই সাফিক্সটি নিতে পারি এবং এর শেষ অক্ষর সরিয়ে দিতে পারি।
আমরা $\pi[i + 1] - 1$ দৈর্ঘ্যের $i$ অবস্থানে শেষ হওয়া একটি সাফিক্স পাই, যা $\pi[i]$-এর চেয়ে ভালো, অর্থাৎ আমরা একটি দ্বন্দ্ব পাই।

নিচের চিত্রটি এই দ্বন্দ্ব দেখায়।
$i$ অবস্থানে দীর্ঘতম প্রকৃত সাফিক্স যা প্রিফিক্সও তার দৈর্ঘ্য $2$, এবং $i+1$ অবস্থানে এটা $4$।
...
এটা করতে, আমাদের আগের ধাপগুলোতে গণনাকৃত সকল তথ্য ব্যবহার করতে হবে।
...
এটা আবার একটি উদাহরণ দিয়ে চিত্রিত করা হয়েছে।
...
আসলে, যদি আমরা এরকম দৈর্ঘ্য $j$ পাই, তাহলে আবার শুধু অক্ষর $s[i+1]$ এবং $s[j]$ তুলনা করতে হবে।
...
চিত্রটি দেখায় যে, এটা অবশ্যই $\pi[j-1]$-এর মান, যা আমরা আগেই গণনা করেছি।
...
- বর্তমান মান $\pi[i]$ গণনা করতে আমরা ভেরিয়েবল $j$ সেট করি যা $i-1$-এর জন্য সেরা সাফিক্সের দৈর্ঘ্য নির্দেশ করে। শুরুতে $j = \pi[i-1]$।
- পরীক্ষা করি $j+1$ দৈর্ঘ্যের সাফিক্সটিও প্রিফিক্স কিনা, $s[j]$ এবং $s[i]$ তুলনা করে।
যদি সমান হয় তাহলে $\pi[i] = j + 1$ অ্যাসাইন করি, অন্যথায় $j$-কে $\pi[j-1]$-এ কমাই এবং এই ধাপ রিপিট করি।
...
এটা একটি **অনলাইন** অ্যালগরিদম, অর্থাৎ এটা ডেটা আসার সাথে সাথে প্রক্রিয়া করে - উদাহরণস্বরূপ, তুমি স্ট্রিং-এর অক্ষরগুলো একটি একটি করে পড়তে পারো এবং সঙ্গে সঙ্গে প্রক্রিয়া করতে পারো, প্রতিটি পরবর্তী অক্ষরের জন্য প্রিফিক্স ফাংশনের মান বের করে।
...
কিন্তু আমাদের ক্ষেত্রে এটা $s$-এর সাথে মিলে যাওয়া এবং $i$ অবস্থানে শেষ হওয়া সবচেয়ে বড় ব্লক ছাড়া আর কিছু নয়।
সেপারেটরের কারণে এই দৈর্ঘ্য $n$-এর চেয়ে বড় হতে পারে না।
কিন্তু যদি $\pi[i] = n$ সমতা অর্জিত হয়, তাহলে এর মানে স্ট্রিং $s$ এই অবস্থানে সম্পূর্ণরূপে উপস্থিত, অর্থাৎ এটা $i$ অবস্থানে শেষ হয়।
শুধু ভুলো না যে অবস্থানগুলো $s + \# + t$ স্ট্রিং-এ ইনডেক্সড।
...
$i$ অবস্থানে প্রিফিক্স ফাংশনের মান $\pi[i]$ কনসিডার করো।
...
তাই আমরা এভাবে উত্তর গণনা করতে পারি।
...
এখানে প্রিফিক্স ফাংশনের প্রতিটি মানের জন্য আমরা প্রথমে গণনা করি এটা $\pi$ অ্যারেতে কতবার ঘটে, এবং তারপর চূড়ান্ত উত্তর গণনা করি:
...
এখন দ্বিতীয় সমস্যাটি কনসিডার করি।
...
আমরা এই সমস্যাটি ইটারেটিভভাবে সমাধান করব।
...
আমরা স্ট্রিং $t = s + c$ নিই এবং এটা বিপরীত করি।
...
এটা স্পষ্ট যে, আমাদের শুধু $t$-এর দৈর্ঘ্য খুঁজতে হবে। দৈর্ঘ্য জানা থাকলে, সমস্যার উত্তর হবে এই দৈর্ঘ্যের $s$-এর প্রিফিক্স।

$s$-এর জন্য প্রিফিক্স ফাংশন গণনা করি।
এর শেষ মান ব্যবহার করে মান $k = n - \pi[n - 1]$ ডিফাইন করি।
...
অবশ্যই আমাদের এখনও দেখাতে হবে এটা আসলেই অপটিমাম।
আসলে, যদি $k$-এর চেয়ে ছোট সংকুচন থাকত, তাহলে শেষে প্রিফিক্স ফাংশনের মান $n - k$-এর চেয়ে বড় হতো।
তাই $k$ সত্যিই উত্তর।

এখন ধরি $n$, $k$ দ্বারা বিভাজ্য নয়।
আমরা দেখাই যে এর মানে উত্তরের দৈর্ঘ্য $n$।
আমরা দ্বন্দ্ব দিয়ে প্রুফ করি।
...
এখন স্ট্রিং-এর দ্বিতীয় ব্লক কনসিডার করো।
...
কিন্তু তাহলে স্ট্রিংটি শুধু একটি অক্ষরের রিপিটিশন (Repetition), ফলে এটা $1$ আকারের স্ট্রিং-এ সংকুচিত হয়, যা $k = 1$ দেয়, এবং $k$, $n$ ভাগ করে।
দ্বন্দ্ব।
...
চলো সেপারেটর দিয়ে দুটি স্ট্রিং-এর সংযুক্তিতে ফিরে যাই, অর্থাৎ স্ট্রিং $s$ এবং $t$-এর জন্য আমরা $s + \# + t$ স্ট্রিং-এর প্রিফিক্স ফাংশন গণনা করি।
...
$$\underbrace{s_0 ~ s_1 ~ \dots ~ s_{n-1} ~ \#}_{\text{to store}} ~ \underbrace{t_0 ~ t_1 ~ \dots ~ t_{m-1}}_{\text{not to store}}$$

আসলে, এরকম পরিস্থিতিতে পরবর্তী অক্ষর $c \in t$ এবং আগের অবস্থানের প্রিফিক্স ফাংশনের মান জানা থাকলেই পরবর্তী প্রিফিক্স ফাংশনের মান গণনা করার জন্য যথেষ্ট তথ্য থাকে, স্ট্রিং $t$-এর কোনো আগের অক্ষর বা তাদের প্রিফিক্স ফাংশনের মান ব্যবহার না করেই।
...
লক্ষ্য করো আমরা ডায়নামিক প্রোগ্রামিং প্রয়োগ করতে পারি এবং টেবিলের ইতিমধ্যে গণনাকৃত অংশ ব্যবহার করতে পারি।
...
শুরুতে মনে রাখো আমরা স্ট্রিং $s + \# + t$-এর প্রিফিক্স ফাংশন এবং এর মানগুলো বেশিরভাগ ক্ষেত্রে একটি একক উদ্দেশ্যে ব্যবহার করি: স্ট্রিং $t$-তে স্ট্রিং $s$-এর সকল অবস্থান খোঁজা।
...
এটা যেমন হতে পারে গ্রে স্ট্রিং, বা ইনপুটের কয়েকটি সংক্ষিপ্ত স্ট্রিং-এর রিকার্সিভ সমন্বয়ে গঠিত স্ট্রিং।
...
মনে রাখো গ্রে-এর স্ট্রিং এভাবে ডিফাইন করা:
...
এবং সকল পরবর্তী মান আগের মান এবং অটোমেটন ব্যবহার করে গণনা করা যায়।
...
উদাহরণস্বরূপ একই পদ্ধতি নিচের সমস্যাও সমাধান করে:
একটি স্ট্রিং $s$ এবং কিছু প্যাটার্ন $t_i$ দেওয়া আছে, প্রতিটি এভাবে নির্দিষ্ট:
এটা সাধারণ অক্ষরের একটি স্ট্রিং, এবং $t_k^{\text{cnt}}$ আকারে আগের স্ট্রিং-এর রিকার্সিভ ইনসার্শন থাকতে পারে, যার মানে সেই জায়গায় $t_k$ স্ট্রিং $\text{cnt}$ বার ইনসার্ট হবে।
...
সমস্যাটি একইভাবে সমাধান করা যায় প্রিফিক্স ফাংশনের অটোমেটন তৈরি করে, এবং তারপর আগের ফলাফল ব্যবহার করে প্রতিটি প্যাটার্নের ট্রানজিশন গণনা করে।
