...
$n$ সংখ্যার বিট এবং $G(n)$ সংখ্যার বিটগুলো দেখা যাক। লক্ষ্য কর যে $G(n)$-এর $i$-তম বিট কেবল তখনই ১ হয় যখন $n$-এর $i$-তম বিট ১ এবং $i + 1$-তম বিট ০ অথবা উল্টোটি ($i$-তম বিট ০ এবং $i + 1$-তম বিট ১)। সুতরাং, $G(n) = n \oplus (n >> 1)$:
...
গ্রে কোড $g$ দেওয়া আছে, মূল সংখ্যা $n$ রিকভার করতে হবে।
...
কোডে এটা লেখার সবচেয়ে সহজ উপায়:
...
*   টাওয়ার্স অব হ্যানয় সমস্যা সমাধানে গ্রে কোড ব্যবহার করা যায়।
    মনে করি $n$ হলো চাকতির সংখ্যা। $n$ দৈর্ঘ্যের গ্রে কোড দিয়ে শুরু করো যেটি
    ...
    (সবচেয়ে কম তাৎপর্যপূর্ণ বিট সবচেয়ে ছোট চাকতি এবং সবচেয়ে উচ্চ তাৎপর্যপূর্ণ বিট সবচেয়ে বড় চাকতি বোঝায়)।
    যেহেতু প্রতিটি ধাপে ঠিক একটি বিট পরিবর্তন হয়, আমরা $i$-তম বিটের পরিবর্তনকে $i$-তম চাকতি সরানো হিসেবে কনসিডার করতে পারি।
    লক্ষ্য কর যে প্রতিটি ধাপে প্রতিটি চাকতির (সবচেয়ে ছোটটি বাদে) জন্য ঠিক একটি সরানোর বিকল্প আছে (শুরু এবং শেষ অবস্থান বাদে)।
