...
সবচেয়ে আদর্শ সমস্যা যা বাইনারি সার্চের দিকে নিয়ে যায় তা হলো এরকম। তোমাকে একটি সর্টেড অ্যারে $A_0 \leq A_1 \leq \dots \leq A_{n-1}$ দেওয়া আছে, পরীক্ষা করো $k$ এই ক্রমের মধ্যে আছে কিনা। সবচেয়ে সরল সমাধান হলো প্রতিটি উপাদান একে একে যাচাই করে $k$-এর সাথে তুলনা করা (একে লিনিয়ার সার্চ বলা হয়)। এই পদ্ধতি $O(n)$-এ কাজ করে, কিন্তু অ্যারে যে সর্টেড সেই তথ্যটি কাজে লাগায় না।
...
যখন $M$ নেওয়া সম্ভব হয় না, অর্থাৎ যখন $R = L + 1$, তখন আমরা সরাসরি $k$-কে $A_L$ এবং $A_R$-এর সাথে তুলনা করি। অন্যথায় আমরা $M$ এমনভাবে বাছাই করতে চাই যেন _সবচেয়ে খারাপ ক্ষেত্রে_ এটা সক্রিয় সেগমেন্টকে যত দ্রুত সম্ভব একটি মাত্র উপাদানে কমিয়ে আনে।
...
অন্যভাবে বলতে গেলে, সবচেয়ে খারাপ ক্ষেত্রের দৃষ্টিকোণ থেকে সবসময় $M$-কে $[L, R]$-এর মাঝখানে নিয়ে অর্ধেক ভাগ করাই সর্বোত্তম। এভাবে সক্রিয় সেগমেন্ট প্রতিটি ধাপে অর্ধেক হতে থাকে যতক্ষণ না এটাআকার $1$ হয়। সুতরাং, যদি প্রক্রিয়াটিতে $h$ ধাপ লাগে, শেষ পর্যন্ত এটা$R$ ও $L$-এর পার্থক্য $R-L$ থেকে $\frac{R-L}{2^h} \approx 1$-এ কমিয়ে আনে, যেখান থেকে আমরা ইকুয়েশন পাই $2^h \approx R-L$।
...
প্রায়ই $k$-এর সঠিক অবস্থান খোঁজার বদলে প্রথম যে উপাদানটি $k$-এর সমান বা বড় সেটার অবস্থান (অ্যারেতে $k$-এর লোয়ার বাউন্ড) অথবা প্রথম যে উপাদানটি $k$-এর চেয়ে বড় সেটার অবস্থান ($k$-এর আপার বাউন্ড) খোঁজা সুবিধাজনক।
...
উপরের ব্যাখ্যাটি অ্যালগরিদমের একটি মোটামুটি বর্ণনা দেয়। ইমপ্লিমেন্টেশনের বিস্তারিতের জন্য আমাদের আরও স্পষ্ট হতে হবে।
...
যখন $R = L+1$, তখন উপরের সংজ্ঞা থেকে আমরা বলতে পারি যে $R$ হলো $k$-এর আপার বাউন্ড। $R$-কে past-the-end ইনডেক্স, অর্থাৎ $R=n$, এবং $L$-কে before-the-beginning ইনডেক্স, অর্থাৎ $L=-1$ দিয়ে ইনিশিয়ালাইজ করা সুবিধাজনক। আমাদের অ্যালগরিদমে যতক্ষণ আমরা সরাসরি $A_L$ এবং $A_R$ ইভ্যালুয়েট না করি ততক্ষণ এটাঠিক আছে, ফর্মালি $A_L = -\infty$ এবং $A_R = +\infty$ ধরে নেওয়া যায়।

আর $M$-এর মান হিসেবে আমরা $M = \lfloor \frac{L+R}{2} \rfloor$ ব্যবহার করব।
...
অ্যালগরিদম চলাকালীন আমরা কখনো $A_L$ বা $A_R$ ইভ্যালুয়েট করি না, কারণ $L < M < R$। শেষে, $L$ হবে শেষ উপাদানটির ইনডেক্স যেটা $k$-এর চেয়ে বড় নয় (অথবা $-1$ যদি এমন কোনো উপাদান না থাকে) এবং $R$ হবে $k$-এর চেয়ে বড় প্রথম উপাদানটির ইনডেক্স (অথবা $n$ যদি এমন কোনো উপাদান না থাকে)।

**দ্রষ্টব্য।** `m`-কে `m = (r + l) / 2` হিসেবে হিসাব করলে ওভারফ্লো হতে পারে যদি `l` এবং `r` দুটি পজিটিভ ইন্টিজার হয়, এবং এই বাগটি প্রায় ৯ বছর JDK-তে ছিল যা এই [ব্লগপোস্টে](https://ai.googleblog.com/2006/06/extra-extra-read-all-about-it-nearly.html) দেখানো হয়েছে। কিছু বিকল্প পদ্ধতির মধ্যে রয়েছে যেমন `m = l + (r - l) / 2` লেখা যা পজিটিভ ইন্টিজার `l` ও `r`-এর জন্য সবসময় কাজ করে, কিন্তু `l` নেগেটিভ হলে এখনও ওভারফ্লো হতে পারে। তুমি যদি C++20 ব্যবহার করো, তাহলে `m = std::midpoint(l, r)` আকারে একটি বিকল্প সমাধান পাওয়া যায় যা সবসময় সঠিকভাবে কাজ করে।

## যেকোনো প্রেডিকেটে সার্চ

ধরি $f : \{0,1,\dots, n-1\} \to \{0, 1\}$ হলো $0,1,\dots,n-1$-এ ডিফাইন করা একটি বুলিয়ান ফাংশন যা মনোটনিকভাবে বর্ধমান, অর্থাৎ
...
$k < A_M$-এর বদলে যেকোনো মনোটনিক প্রেডিকেট ব্যবহার করা সম্ভব। এটাবিশেষভাবে উপযোগী যখন $f(k)$-এর হিসাব করতে এত বেশি সময় লাগে যে প্রতিটি সম্ভাব্য মানের জন্য এটাগণনা করা ব্যবহারিক নয়।
...
ট্রানজিশন পয়েন্ট আছে ধরে নিয়ে সঠিকতার প্রুফ, অর্থাৎ $f(0)=0$ এবং $f(n-1)=1$: ইমপ্লিমেন্টেশনটি _লুপ ইনভ্যারিয়েন্ট_ $f(l)=0, f(r)=1$ বজায় রাখে। যখন $r - l > 1$, $m$-এর বাছাই নিশ্চিত করে যে $r-l$ সবসময় কমবে। লুপটি $r - l = 1$ হলে শেষ হয়, যা আমাদের কাঙ্ক্ষিত ট্রানজিশন পয়েন্ট দেয়।
...
এই পরিস্থিতি প্রায়ই দেখা যায় যখন আমাদের কোনো মান গণনা করতে বলা হয়, কিন্তু আমরা কেবল পরীক্ষা করতে পারি এই মানটি কমপক্ষে $i$ কিনা। উদাহরণস্বরূপ, তোমাকে একটি অ্যারে $a_1,\dots,a_n$ দেওয়া আছে এবং তোমাকে সর্বোচ্চ ফ্লোরড গড় যোগফল খুঁজে বের করতে বলা হয়েছে
...
সমতুল্যভাবে, এটাপুনর্লিখন করা যায়
...
সাধারণতা না হারিয়ে ধরি $f(L) \leq f(R)$। [মধ্যবর্তী মান থিওরেম](https://en.wikipedia.org/wiki/Intermediate_value_theorem) থেকে বলা যায় যে যেকোনো $y \in [f(L), f(R)]$-এর জন্য এমন $x \in [L, R]$ আছে যেন $f(x) = y$। লক্ষ্য করো, আগের অনুচ্ছেদগুলোর বিপরীতে, ফাংশনটি মনোটনিক হওয়ার _প্রয়োজন নেই_।
...
বাইনারি সার্চ করার আরেকটি উল্লেখযোগ্য উপায় হলো, একটি সক্রিয় সেগমেন্ট বজায় রাখার বদলে, বর্তমান পয়েন্টার $i$ এবং বর্তমান পাওয়ার $k$ বজায় রাখা। পয়েন্টার $i=L$ থেকে শুরু হয় এবং তারপর প্রতিটি ইটারেশনে $i+2^k$ বিন্দুতে প্রেডিকেট পরীক্ষা করা হয়। যদি প্রেডিকেট এখনও $0$ থাকে, তাহলে পয়েন্টার $i$ থেকে $i+2^k$-এ এগিয়ে যায়, অন্যথায় এটাএকই থাকে, তারপর পাওয়ার $k$ ১ কমানো হয়।

এই পদ্ধতি ট্রি-সম্পর্কিত সমস্যায় ব্যাপকভাবে ব্যবহৃত হয়, যেমন দুটি ভার্টেক্সের LCA খোঁজা অথবা একটি নির্দিষ্ট ভার্টেক্সের এমন পূর্বপুরুষ খোঁজা যার একটি নির্দিষ্ট উচ্চতা আছে। এটাফেনউইক ট্রি-তে $k$-তম নন-জিরো উপাদান খোঁজার মতো কাজেও ব্যবহার করা যায়।
