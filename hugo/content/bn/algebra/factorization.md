...
লক্ষ্য কর, তুমি যে সংখ্যাটা ফ্যাক্টরাইজ করতে চাও সেটা আসলে একটা মৌলিক সংখ্যা হলে, বেশিরভাগ অ্যালগরিদম অত্যন্ত ধীরে চলবে। এটা বিশেষ করে ফের্মার, পোলার্ডের p-1 এবং পোলার্ডের রো ফ্যাক্টরাইজেশন অ্যালগরিদমের জন্য সত্য।
তাই, সংখ্যাটা ফ্যাক্টরাইজ করার চেষ্টা করার আগে একটা প্রোবাবিলিস্টিক (অথবা দ্রুত ডিটারমিনিস্টিক) [প্রাইমালিটি টেস্ট](primality_tests.md) করা সবচেয়ে যুক্তিসঙ্গত।

## ট্রায়াল ডিভিশন

এটা মৌলিক উৎপাদক বিভাজন খুঁজে বের করার সবচেয়ে মৌলিক অ্যালগরিদম।

আমরা প্রতিটি সম্ভাব্য ডিভাইজর $d$ দ্বারা ভাগ করি।
লক্ষ্য করা যায় যে একটি যৌগিক সংখ্যা $n$-এর সকল মৌলিক ফ্যাক্টর $\sqrt{n}$-এর চেয়ে বড় হওয়া অসম্ভব।
তাই, আমাদের শুধু $2 \le d \le \sqrt{n}$ ডিভাইজরগুলো পরীক্ষা করতে হবে, যা $O(\sqrt{n})$-এ মৌলিক উৎপাদক বিভাজন দেয়।
(এটা [সিউডো-পলিনোমিয়াল টাইম](https://en.wikipedia.org/wiki/Pseudo-polynomial_time), অর্থাৎ ইনপুটের মানের পলিনোমিয়াল কিন্তু ইনপুটের বিটের সংখ্যার এক্সপোনেনশিয়াল।)

ক্ষুদ্রতম ডিভাইজরটি অবশ্যই একটি মৌলিক সংখ্যা।
আমরা ফ্যাক্টর করা সংখ্যাটি সরিয়ে ফেলি, এবং প্রক্রিয়া চালিয়ে যাই।
$[2; \sqrt{n}]$ রেঞ্জে কোনো ডিভাইজর খুঁজে পাওয়া না গেলে, সংখ্যাটি নিজেই মৌলিক।
...
এটা ট্রায়াল ডিভিশনের একটি অপটিমাইজেশন।
...
আমরা প্রথমে ২ এবং ৩ মৌলিক সংখ্যাগুলো ফ্যাক্টর করে বের করে এটা ইমপ্লিমেন্ট করতে পারি, তারপর ৫ থেকে শুরু করে ৬ মডুলোতে ভাগশেষ $1$ এবং $5$ গণনা করতে পারি।
...
এটা পরীক্ষা করার একটি ভালো উপায় হলো $\sqrt{n}$ পর্যন্ত সকল মৌলিক সংখ্যা [ইরাতোস্থেনিসের চালুনি](sieve-of-eratosthenes.md) দিয়ে প্রিকম্পিউট করা, এবং সেগুলো পৃথকভাবে পরীক্ষা করা।
...
যদি হয়, তাহলে আমরা $n$-এর ফ্যাক্টর $a - b$ এবং $a + b$ খুঁজে পেয়েছি।
...
দুটি ফ্যাক্টর $p$ এবং $q$-এর পার্থক্য ছোট হলে এই ফ্যাক্টরাইজেশন পদ্ধতি অত্যন্ত দ্রুত হতে পারে।
অ্যালগরিদমটি $O(|p - q|)$ সময়ে চলে।
তবে প্র্যাকটিসে, এই পদ্ধতি খুব কমই ব্যবহৃত হয়। ফ্যাক্টরগুলো দূরে সরে গেলে, এটা অত্যন্ত ধীর।
...
এটা অত্যন্ত সম্ভাবনাময় যে একটি সংখ্যা $n$-এর অন্তত একটি মৌলিক ফ্যাক্টর $p$ আছে যেন $p - 1$ ছোট $\mathrm{B}$-এর জন্য $\mathrm{B}$**-পাওয়ারস্মুথ**। একটি পূর্ণসংখ্যা $m$-কে $\mathrm{B}$-পাওয়ারস্মুথ বলা হয় যদি $m$-কে ভাগ করে এমন প্রতিটি মৌলিক ঘাত সর্বাধিক $\mathrm{B}$ হয়। ফর্মালি, ধরি $\mathrm{B} \geqslant 1$ এবং $m$ যেকোনো ধনাত্মক পূর্ণসংখ্যা। ধরো $m$-এর মৌলিক উৎপাদক বিভাজন $m = \prod {q_i}^{e_i}$, যেখানে প্রতিটি $q_i$ মৌলিক এবং $e_i \geqslant 1$। তাহলে $m$ $\mathrm{B}$-পাওয়ারস্মুথ যদি, সকল $i$-এর জন্য, ${q_i}^{e_i} \leqslant \mathrm{B}$।
...
১৯৭৪ সালে জন পোলার্ড একটি যৌগিক সংখ্যা থেকে এমন ফ্যাক্টর $p$ বের করার একটি পদ্ধতি আবিষ্কার করেন, যেখানে $p-1$ হলো $\mathrm{B}$-পাওয়ারস্মুথ।

ধারণাটি আসে [ফের্মার ক্ষুদ্র থিওরেম](phi-function.md#application) থেকে।
ধরি $n$-এর ফ্যাক্টরাইজেশন $n = p \cdot q$।
এটা বলে যে $a$ যদি $p$-এর সহমৌলিক হয়, তাহলে নিচের উক্তি ধরে:
...
তাই, যদি $n$-এর কোনো ফ্যাক্টর $p$-এর জন্য $p - 1$ $M$-কে ভাগ করে, আমরা [ইউক্লিডের অ্যালগরিদম](euclid-algorithm.md) ব্যবহার করে একটি ফ্যাক্টর বের করতে পারি।

এটা স্পষ্ট যে, প্রতিটি $\mathrm{B}$-পাওয়ারস্মুথ সংখ্যার গুণিতক সর্বনিম্ন $M$ হলো $\text{lcm}(1,~2~,3~,4~,~\dots,~B)$।
বিকল্পভাবে:

$$M = \prod_{\text{prime } q \le B} q^{\lfloor \log_q B \rfloor}$$

লক্ষ্য কর, $n$-এর সকল মৌলিক ফ্যাক্টর $p$-এর জন্য $p-1$ যদি $M$-কে ভাগ করে, তাহলে $\gcd(a^M - 1, n)$ কেবল $n$ হবে।
এই ক্ষেত্রে আমরা কোনো ফ্যাক্টর পাই না।
তাই, আমরা $M$ গণনা করার সময় একাধিকবার $\gcd$ করার চেষ্টা করব।

কিছু যৌগিক সংখ্যার এমন কোনো ফ্যাক্টর $p$ নেই যেন $p-1$ ছোট $\mathrm{B}$-এর জন্য $\mathrm{B}$-পাওয়ারস্মুথ।
...
নিচের ইমপ্লিমেন্টেশনে আমরা $\mathrm{B} = 10$ দিয়ে শুরু করি এবং প্রতিটি ইটারেশনের পরে $\mathrm{B}$ বৃদ্ধি করি।
...
লক্ষ্য কর যে এটা একটি প্রোবাবিলিস্টিক অ্যালগরিদম।
এর একটি পরিণতি হলো অ্যালগরিদম কোনো ফ্যাক্টর খুঁজে পাওয়ার ব্যর্থ হওয়ার সম্ভাবনা আছে।
...
সিকোয়েন্সের আকৃতি থেকে তুমি স্পষ্টভাবে দেখতে পারেন কেন অ্যালগরিদমটিকে পোলার্ডের $\rho$ অ্যালগরিদম বলা হয়।
...
এই ইকুয়েশনটি $x_s - x_t \equiv 0 \bmod p$ হিসেবে পুনরায় লেখা যায় যা $p ~|~ \gcd(x_s - x_t, n)$-এর সমান।

তাই, যদি আমরা $g = \gcd(x_s - x_t, n) > 1$ সহ দুটি ইনডেক্স $s$ ও $t$ খুঁজে পাই, আমরা একটি সাইকেল এবং $n$-এর একটি ফ্যাক্টর $g$ উভয়ই পেয়েছি।
$g = n$ হওয়া সম্ভব।
সেক্ষেত্রে আমরা কোনো সঠিক ফ্যাক্টর পাইনি, তাই ভিন্ন প্যারামিটার দিয়ে (ভিন্ন শুরুর মান $x_0$, পলিনোমিয়াল ফাংশন $f$-এ ভিন্ন ধ্রুবক $c$) প্রক্রিয়াটি পুনরাবৃত্তি করতে হবে।
...
এই অ্যালগরিদম ব্যবহার করে $\lambda$ এবং $\mu$ প্যারামিটার ডিটারমিন করাও সম্ভব ($O(\lambda + \mu)$ সময়ে এবং $O(1)$ স্পেসে)।
সাইকেল সনাক্ত হলে, অ্যালগরিদম 'True' রিটার্ন করবে।
সিকোয়েন্সে সাইকেল না থাকলে, ফাংশনটি অনির্দিষ্টকালের জন্য লুপ করবে।
তবে, পোলার্ডের রো অ্যালগরিদম ব্যবহার করে এটা প্রতিরোধ করা যায়।
...
নিচের টেবিলটি $n = 2206637$, $x_0 = 2$ এবং $c = 1$-এর জন্য অ্যালগরিদমের সময় $x$ ও $y$-এর মান দেখায়।
...
GCC পাওয়া না গেলে, তুমি [বাইনারি এক্সপোনেনশিয়েশনের](binary-exp.md) অনুরূপ একটি ধারণা ব্যবহার করতে পারেন।
...
বিকল্পভাবে তুমি [মন্টগোমারি মাল্টিপ্লিকেশন](montgomery_multiplication.md)ও ইমপ্লিমেন্ট করতে পারেন।

পূর্বে বলা হয়েছে, $n$ যৌগিক হলে এবং অ্যালগরিদম $n$-কে ফ্যাক্টর হিসেবে রিটার্ন করলে, তোমাকে ভিন্ন প্যারামিটার $x_0$ ও $c$ দিয়ে প্রক্রিয়াটি পুনরাবৃত্তি করতে হবে।
যেমন $x_0 = c = 1$ বেছে নিলে $25 = 5 \cdot 5$ ফ্যাক্টরাইজ করবে না।
অ্যালগরিদম $25$ রিটার্ন করবে।
তবে, $x_0 = 1$, $c = 2$ বেছে নিলে এটা ফ্যাক্টরাইজ করবে।
...
ব্রেন্টের অ্যালগরিদমও রৈখিক সময়ে চলে, তবে সাধারণত ফ্লয়ডের চেয়ে দ্রুত, কারণ এটা ফাংশন $f$-এর কম ইভ্যালুয়েশন ব্যবহার করে।
