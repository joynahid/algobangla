...
একটি লিংকড লিস্ট (linked list) দেওয়া আছে যেখানে সেই লিংকড লিস্টের শুরুর বিন্দু **head** দ্বারা চিহ্নিত, এবং সেখানে সাইকেল থাকতেও পারে, নাও থাকতে পারে। উদাহরণস্বরূপ:
...
২. উভয়ই শুরুতে লিংকড লিস্টের head-এ পয়েন্ট করবে।
৩. $slow$ একবারে একটি ধাপ এগোবে।
৪. $fast$ একবারে দুটি ধাপ এগোবে ($slow$ পয়েন্টারের দ্বিগুণ গতিতে)।
৫. কোনো একটি (বা উভয়) null-এ পৌঁছানোর আগে কোনো সময়ে তারা একই নোডে পয়েন্ট করে কি না তা পরীক্ষা করো।
৬. যদি তাদের যাত্রার কোনো সময়ে তারা একই নোডে পয়েন্ট করে, তাহলে এটা বোঝায় যে লিংকড লিস্টে আসলে একটি সাইকেল বিদ্যমান।
৭. যদি আমরা null পাই, তাহলে এটা বোঝায় যে লিংকড লিস্টে কোনো সাইকেল নেই।
...
১. $slow$ পয়েন্টারকে লিংকড লিস্টের **head**-এ রিসেট করো।
২. উভয় পয়েন্টারকে একবারে একটি ধাপ করে এগিয়ে নাও।
৩. যে বিন্দুতে তারা মিলিত হবে সেটাই হবে সাইকেলের শুরুর বিন্দু।
...
যখন slow পয়েন্টার $k \cdot L$ ধাপ চলেছে, এবং fast পয়েন্টার $2 \cdot k \cdot L$ ধাপ অতিক্রম করেছে, উভয় পয়েন্টারই সাইকেলের মধ্যে থাকে। এই সময়ে, তাদের মধ্যে $k \cdot L$ দূরত্ব আছে। যেহেতু সাইকেলের দৈর্ঘ্য $L$, এটা বোঝায় যে তারা সাইকেলের মধ্যে একই বিন্দুতে মিলিত হয়, ফলে তাদের সাক্ষাৎ ঘটে।
