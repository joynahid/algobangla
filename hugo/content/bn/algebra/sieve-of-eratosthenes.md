...
এরপর আমরা পরবর্তী যে সংখ্যাটি যৌগিক হিসেবে চিহ্নিত হয়নি সেটা খুঁজে বের করি, এক্ষেত্রে সেটা হলো ৩।
...
সুতরাং, আমরা যখন একটি ঘরে পৌঁছাই এবং সেটা চিহ্নিত না থাকে, তাহলে এটা কোনো ছোট মৌলিক সংখ্যা দ্বারা বিভাজ্য নয় এবং তাই এটা অবশ্যই মৌলিক।
...
এর জন্য এটা $2$ থেকে $n$ পর্যন্ত সকল সংখ্যার উপর ইটারেট করে।
বর্তমান সংখ্যা $i$ যদি মৌলিক সংখ্যা হয়, তাহলে এটা $i^2$ থেকে শুরু করে $i$-এর সকল গুণিতককে যৌগিক সংখ্যা হিসেবে চিহ্নিত করে।
এটা ইতিমধ্যেই সাধারণ ইমপ্লিমেন্টেশনের তুলনায় একটি অপটিমাইজেশন, এবং এটা সম্ভব কারণ $i$-এর গুণিতক যেসব ছোট সংখ্যা আছে সেগুলোর অবশ্যই $i$-এর চেয়ে ছোট একটি মৌলিক ফ্যাক্টর রয়েছে, তাই সেগুলো আগেই ছাঁকা হয়ে গেছে।
...
এই ইমপ্লিমেন্টেশন ব্যবহার করলে অ্যালগরিদমটি $O(n)$ মেমোরি ব্যবহার করে (যা স্পষ্টতই) এবং $O(n \log \log n)$ অপারেশন করে (পরবর্তী বিভাগ দেখো)।

## অ্যাসিম্পটোটিক অ্যানালাইসিস

মৌলিক সংখ্যার বিতরণ সম্পর্কে কিছু না জেনেও $O(n \log n)$ রানিং টাইম প্রুফ করা সহজ — `is_prime` চেক উপেক্ষা করলে, ভেতরের লুপটি $i = 2, 3, 4, \dots$-এর জন্য (সর্বোচ্চ) $n/i$ বার চলে, যার ফলে ভেতরের লুপে মোট অপারেশনের সংখ্যা একটি হারমোনিক সিরিজের মতো হয় যেমন $n(1/2 + 1/3 + 1/4 + \cdots)$, যা $O(n \log n)$ দ্বারা সীমাবদ্ধ।

এবার প্রুফ করা যাক যে অ্যালগরিদমের রানিং টাইম হলো $O(n \log \log n)$।
ভেতরের লুপে অ্যালগরিদমটি প্রতিটি মৌলিক সংখ্যা $p \le n$-এর জন্য $\frac{n}{p}$ অপারেশন করবে।
...
দুটি পরিচিত তথ্য স্মরণ করা যাক।
  ...
  - $k$-তম মৌলিক সংখ্যা আনুমানিক $k \ln k$-এর সমান (এটা আগের তথ্য থেকে অনুমিত)।
...
এখন, $k$-এর উপর $2$ থেকে $\frac n {\ln n}$ পর্যন্ত একই ফাংশনের ইন্টিগ্রাল ব্যবহার করে এই যোগফল মূল্যায়ন করা যাক (আমরা এই আসন্নীকরণ করতে পারি কারণ, আসলে, যোগফলটি আয়তক্ষেত্র পদ্ধতি ব্যবহার করে ইন্টিগ্রালের আসন্ন মানের সাথে সম্পর্কিত):
...
আরও কঠোর প্রুফ (যা ধ্রুবক গুণকের মধ্যে আরও সুনির্দিষ্ট মূল্যায়ন দেয়) Hardy ও Wright রচিত "An Introduction to the Theory of Numbers" গ্রন্থে (পৃ. ৩৪৯) পাওয়া যাবে।

## এরাটোস্থেনিসের সিভের বিভিন্ন অপটিমাইজেশন

অ্যালগরিদমটির সবচেয়ে বড় দুর্বলতা হলো, এটা মেমোরিতে একাধিকবার "হেঁটে" যায় এবং প্রতিবার শুধুমাত্র একক উপাদান পরিবর্তন করে।
এটা খুব বেশি ক্যাশ-ফ্রেন্ডলি নয়।
...
এই অপটিমাইজেশন কমপ্লেক্সিটিকে প্রভাবিত করে না (আসলে, উপরে উপস্থাপিত প্রুফটি পুনরাবৃত্তি করলে আমরা $n \ln \ln \sqrt n + o(n)$ মূল্যায়ন পাব, যা লগারিদমের বৈশিষ্ট্য অনুসারে অ্যাসিম্পটোটিকভাবে একই), তবে অপারেশনের সংখ্যা উল্লেখযোগ্যভাবে হ্রাস পাবে।
...
প্রথমত, এটা প্রয়োজনীয় মেমোরি অর্ধেক করতে দেবে। দ্বিতীয়ত, এটা অ্যালগরিদম দ্বারা সম্পাদিত অপারেশনের সংখ্যা প্রায় অর্ধেকে নামিয়ে আনবে।

### মেমোরি ব্যবহার এবং অপারেশনের গতি

লক্ষ্য কর: এরাটোস্থেনিসের সিভের এই দুটি ইমপ্লিমেন্টেশন `vector<bool>` ডেটা স্ট্রাকচার ব্যবহার করে $n$ বিট মেমোরি ব্যবহার করে।
...
এটা `vector<T>`-এর একটি মেমোরি-অপটিমাইজেশন স্পেশালাইজেশন, যা মাত্র $\frac{N}{8}$ বাইট মেমোরি ব্যবহার করে।
...
তুমি ক্যাশে কত দ্রুত ডেটা লোড করতে পারবেন তার দ্বারা তুমি সীমাবদ্ধ, এবং তাই কম মেমোরি ব্যবহার একটি বড় সুবিধা দেয়।
...
একই কনসিডার `bitset`-এর ক্ষেত্রেও প্রযোজ্য।
...
ধরা যাক $s$ একটি ধ্রুবক যা ব্লকের আকার ডিটারমিন করে, তাহলে মোট $\lceil {\frac n s} \rceil$ টি ব্লক থাকবে, এবং $k$-তম ব্লক ($k = 0 ... \lfloor {\frac n s} \rfloor$) $[ks; ks + s - 1]$ সেগমেন্টের সংখ্যাগুলো ধারণ করে।
...
লক্ষ্য কর: প্রথম সংখ্যাগুলো হ্যান্ডেল করার সময় আমাদের কৌশলটি কিছুটা পরিবর্তন করতে হবে: প্রথমত, $[1; \sqrt n]$ থেকে সকল মৌলিক সংখ্যা নিজেদের মুছে ফেলবে না; এবং দ্বিতীয়ত, ০ এবং ১-কে অ-মৌলিক সংখ্যা হিসেবে চিহ্নিত করতে হবে।
...
অন্যদিকে, $[1; \sqrt{n}]$ থেকে প্রতিটি ব্লক ও মৌলিক সংখ্যার জোড়ার জন্য একটি ভাগ অপারেশন থাকবে, এবং ছোট ব্লক সাইজের জন্য সেটা অনেক বেশি খারাপ হবে।
...
সকল মৌলিক সংখ্যা আগে থেকে জেনারেট না করেও এটা করা সম্ভব:
...
স্পষ্টতই, কমপ্লেক্সিটি আরও খারাপ, যা $O((R - L + 1) \log (R) + \sqrt R)$। তবে, এটা বাস্তবে এখনও খুব দ্রুত চলে।

## লিনিয়ার টাইম মডিফিকেশন

আমরা অ্যালগরিদমটিকে এমনভাবে পরিবর্তন করতে পারি যাতে এর টাইম কমপ্লেক্সিটি শুধুমাত্র লিনিয়ার হয়।
এই পদ্ধতিটি [লিনিয়ার সিভ](prime-sieve-linear.md) আর্টিকেলে দেখানো হয়েছেেছে।
