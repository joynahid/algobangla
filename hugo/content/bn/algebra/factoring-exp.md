...
$ax^y \pmod{2^d}$ গণনার একটি সমস্যা কনসিডার করো, যেখানে পূর্ণসংখ্যা $a$, $x$, $y$ এবং $d \geq 3$ দেওয়া আছে, এবং $x$ বিজোড়।

নিচের অ্যালগরিদমটা $O(d)$ যোগ এবং বাইনারি অপারেশন এবং $y$ দ্বারা একটি একক গুণের মাধ্যমে এই সমস্যা সমাধান করতে দেয়।
...
তাহলে `mbin_power_odd_32` এভাবে ইমপ্লিমেন্ট করা হয়:
...
ধরি $x$ একটি বিজোড় সংখ্যা যেন $x \equiv 1 \pmod 4$। এটাকে এভাবে উপস্থাপন করা যায়

$$
x \equiv (2^{a_1}+1)\dots(2^{a_k}+1) \pmod{2^d},
$$

যেখানে $1 < a_1 < \dots < a_k < d$। এখানে $L(\cdot)$ প্রতিটি ফ্যাক্টরের জন্য সুসংজ্ঞায়িত, কারণ তারা $4$ মডুলোতে $1$-এর সমান। তাই,
...
৩২-বিট ইন্টিজারের জন্য, আমরা নিচের টেবিল ব্যবহার করতে পারি:
...
প্র্যাকটিসে, উপরে বর্ণিতটির চেয়ে একটু ভিন্ন পদ্ধতি ব্যবহৃত হয়। $x$-এর ফ্যাক্টরাইজেশন খোঁজার পরিবর্তে, আমরা ক্রমাগত $x$-কে $2^n+1$ দিয়ে গুণ করব যতক্ষণ না এটা $2^d$ মডুলোতে $1$-এ পরিণত হয়। এইভাবে, আমরা $x^{-1}$-এর রিপ্রেজেন্টেশন পাব, অর্থাৎ

$$
x (2^{a_1}+1)\dots(2^{a_k}+1) \equiv 1 \pmod {2^d}.
$$

এটা করতে, আমরা $1 < n < d$ এমন $n$-এর উপর ইটারেট করি। বর্তমান $x$-এর $n$-তম বিট সেট থাকলে, আমরা $x$-কে $2^n+1$ দিয়ে গুণ করি, যা C++-এ সুবিধাজনকভাবে `x = x + (x << n)` হিসেবে করা যায়। এটা $n$-এর চেয়ে নিচের বিটগুলো পরিবর্তন করবে না, তবে $n$-তম বিটকে শূন্যে পরিণত করবে, কারণ $x$ বিজোড়।

এই সব মাথায় রেখে, `mbin_log_32(r, x)` ফাংশনটা এভাবে ইমপ্লিমেন্ট করা হয়:
...
লক্ষ্য করো $4L(x) = -4L(x^{-1})$, তাই $4L(2^n+1)$ যোগ করার পরিবর্তে, আমরা এটা $r$ থেকে বিয়োগ করি, যা শুরুতে $0$-এর সমান।

## 4L(x) থেকে x গণনা

লক্ষ্য করো $k \geq 1$-এর জন্য এটা ধরে রাখে যে
...
এই ফলাফলটা $a=2^n+1$ এবং $b=d-k$-এ প্রয়োগ করলে আমরা অনুমান করি যে $2^n+1$-এর গুণনমূলক অর্ডার $2^{d-n}$-এর একটি ডিভাইজর।
...
সুতরাং $v$ অবশ্যই $k-2$-এর চেয়ে বড় বা সমান হতে হবে। এটা একটু অগোছালো এবং এটা প্রশমিত করতে আমরা শুরুতে বলেছিলাম যে আমরা $L(x)$-কে $4$ দ্বারা গুণ করি। এখন যদি আমরা $4L(x)$ জানি, আমরা $4L(x)$-এর বিটগুলো ক্রমাগত পরীক্ষা করে এটাকে $4L(2^n+1)$-এর যোগফলে স্বতন্ত্রভাবে ডিকম্পোজ করতে পারি। যদি $n$-তম বিট $1$-এ সেট থাকে, আমরা ফলাফলকে $2^n+1$ দিয়ে গুণ করব এবং বর্তমান $4L(x)$ থেকে $4L(2^n+1)$ রিডিউস করব।

সুতরাং, `mbin_exp_32` এভাবে ইমপ্লিমেন্ট করা হয়:
...
তুমি যদি লক্ষ্য করো যে $4L(2^{d-1}+1)=2^{d-1}$ এবং $2k \geq d$-এর জন্য

$$
(2^n+1)^2 \equiv 2^{2n} + 2^{n+1}+1 \equiv 2^{n+1}+1 \pmod{2^d},
$$

তাহলে ইটারেশনের সংখ্যা অর্ধেক করা সম্ভব, যা থেকে অনুমান করা যায় $2n \geq d$ হলে $4L(2^n+1)=2^n$। তাই, তুমি শুধু $\frac{d}{2}$ পর্যন্ত গিয়ে অ্যালগরিদমটা সরলীকৃত করতে পারো এবং তারপর উপরের তথ্য ব্যবহার করে বিটওয়াইজ অপারেশন দিয়ে বাকি অংশ গণনা করতে পারেন:
...
লক্ষ্য করো $g$-এর অর্ডার $2^{d}$-এর বেশি নয় (আসলে $2^{d-2}$-এর বেশি নয়, তবে সুবিধার জন্য আমরা $2^d$ নিয়ে কাজ করব), তাই $k=d-1$ ব্যবহার করলে বাম পক্ষে হয় $g^1$ অথবা $g^0$ থাকবে যা $y^{2^k}$-কে $g$-এর সাথে তুলনা করে $x$-এর ক্ষুদ্রতম বিট ডিটারমিন করতে দেয়। এখন ধরো $x=x_0 + 2^k x_1$, যেখানে $x_0$ জানা অংশ এবং $x_1$ এখনও অজানা। তাহলে
