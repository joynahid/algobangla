...
## সারসংক্ষেপ
ভার্টিক্যাল ডিকম্পোজিশন হলো একটি শক্তিশালী কৌশল যা বিভিন্ন জ্যামিতিক সমস্যায় ব্যবহৃত হয়। মূল ধারণা হলো সমতলকে কিছু "ভালো" বৈশিষ্ট্যকমপ্লিট উল্লম্ব ফিতায় কাটা এবং এই ফিতাগুলোর জন্য স্বাধীনভাবে সমস্যা সমাধান করা। আমরা কিছু উদাহরণের মাধ্যমে এই ধারণাটি ব্যাখ্যা করব।

## ত্রিভুজসমূহের ইউনিয়নের ক্ষেত্রফল
ধরো, একটা সমতলে $n$ টি ত্রিভুজ আছে এবং আমাদের তাদের ইউনিয়নের ক্ষেত্রফল বের করতে হবে। ত্রিভুজগুলো যদি পরস্পরকে ছেদ না করত তাহলে সমস্যাটা সহজ হতো, তাই চলো এই ছেদগুলো থেকে মুক্তি পাই — সমতলকে উল্লম্ব ফিতায় ভাগ করি: সকল শীর্ষবিন্দু এবং বিভিন্ন ত্রিভুজের বাহুগুলোর সকল ছেদবিন্দু দিয়ে উল্লম্ব রেখা আঁকি। এরকম $O(n^2)$ টি রেখা থাকতে পারে তাই আমরা $O(n^2)$ টি ফিতা পাই। এখন একটা উল্লম্ব ফিতা ধরো। প্রতিটি অ-উল্লম্ব রেখাংশ হয় এটাকে বাম থেকে ডানে অতিক্রম করে অথবা মোটেও অতিক্রম করে না।
...
সরলতার জন্য আমরা দেখাব কীভাবে একটি ঊর্ধ্ব রেখাংশের জন্য এটা করা যায়, নিম্ন রেখাংশের জন্য অ্যালগরিদম অনুরূপ। অন্য একটি অ-উল্লম্ব রেখাংশ $t = (t_0, t_1)$ কনসিডার করি এবং $s$ ও $t$-এর $Ox$-এর উপর অভিক্ষেপের ছেদ $[x_1, x_2]$ নির্ণয় করি। যদি এই ছেদ শূন্য হয় বা একটি বিন্দু নিয়ে গঠিত হয়, $t$-কে বাদ দেওয়া যায় কারণ $s$ ও $t$ একই ফিতার অভ্যন্তরে ছেদ করে না। অন্যথায় $s$ ও $t$-এর ছেদ $I$ কনসিডার করি। তিনটি ক্ষেত্র আছে।
...
### অপটিমাইজেশন ২
লক্ষ্য করো, আগের অপটিমাইজেশন প্রয়োগ করলে আমাদের আর সকল ফিতা স্পষ্টভাবে খুঁজতে হয় না। এতে মেমোরি খরচ $O(n)$-এ কমে যায়।

## কনভেক্স পলিগনের ছেদ
ভার্টিক্যাল ডিকম্পোজিশনের আরেকটি ব্যবহার হলো দুটি কনভেক্স পলিগনের ছেদ রৈখিক সময়ে গণনা করা। ধরো প্রতিটা পলিগনের প্রতিটা শীর্ষবিন্দু দিয়ে উল্লম্ব রেখা টেনে সমতলকে উল্লম্ব ফিতায় ভাগ করা হয়েছে। তাহলে কোনো ইনপুট পলিগন এবং কোনো ফিতার ছেদ হয় একটি ট্রাপিজিয়াম, একটি ত্রিভুজ অথবা একটি বিন্দু। সুতরাং আমরা প্রতিটি উল্লম্ব ফিতার জন্য এই আকৃতিগুলোকে সরলভাবে ছেদ করতে এবং এই ছেদগুলোকে একটি একক পলিগনে মার্জ করতে পারি।
