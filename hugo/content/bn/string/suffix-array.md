...
অ্যালগরিদমের প্রতিটি পুনরাবৃত্তিতে, পারমুটেশন $p[० \dots n-१]$ ছাড়াও, যেখানে $p[i]$ হল সাজানো ক্রমে $i$-তম সাবস্ট্রিং ($i$ থেকে শুরু করে এবং দৈর্ঘ্য $२^k$) এর সূচক, আমরা একটি অ্যারে $c[० \dots n-१]$ ও বজায় রাখব, যেখানে $c[i]$ **সমতুল্য শ্রেণী** এর সাথে সামঞ্জস্যপূর্ণ যাতে সাবস্ট্রিং অন্তর্গত।
