...
উদাহরণস্বরূপ নিচের এক্সপ্রেশনটি

$$a + b * c * d + (e - f) * (g * h + i)$$

রিভার্স পোলিশ নোটেশনে এভাবে লেখা যায়:

$$a b c * d * + e f - g h * i + * +$$

রিভার্স পোলিশ নোটেশন অস্ট্রেলিয়ান দার্শনিক ও কম্পিউটার বিজ্ঞান বিশেষজ্ঞ চার্লস হ্যাম্বলিন ১৯৫০-এর দশকের মাঝামাঝিতে পোলিশ নোটেশনের ভিত্তিতে তৈরি করেন, যেটা ১৯২০ সালে পোলিশ গণিতবিদ ইয়ান উকাশেভিচ প্রস্তাব করেছিলেন।

রিভার্স পোলিশ নোটেশনের সুবিধা হলো, এই আকারের এক্সপ্রেশনগুলো লিনিয়ার সময়ে **মূল্যায়ন করা খুব সহজ**।
আমরা একটি স্ট্যাক ব্যবহার করি, যা শুরুতে খালি থাকে।
আমরা রিভার্স পোলিশ নোটেশনের এক্সপ্রেশনের অপারেন্ড এবং অপারেটরগুলোর উপর ইটারেট করব।
যদি বর্তমান উপাদানটি একটি সংখ্যা হয়, তাহলে আমরা মানটি স্ট্যাকের শীর্ষে রাখি। যদি বর্তমান উপাদানটি একটি অপারেটর হয়, তাহলে আমরা স্ট্যাক থেকে শীর্ষের দুটি উপাদান নিই, অপারেশনটি করি, এবং ফলাফলটি আবার স্ট্যাকের শীর্ষে রাখি।
শেষে স্ট্যাকে ঠিক একটি উপাদান থাকবে, যেটা হবে এক্সপ্রেশনের মান।

স্পষ্টতই এই সরল মূল্যায়ন $O(n)$ সময়ে চলে।

## সরল এক্সপ্রেশন পার্সিং

আপাতত আমরা শুধু একটি সরলীকৃত সমস্যা কনসিডার করি:
...
ব্র্যাকেট (Bracket) অনুমোদিত।

আমরা দুটি স্ট্যাক সেট আপ করব: একটি সংখ্যার জন্য, এবং একটি অপারেটর ও ব্র্যাকেটের জন্য।
শুরুতে উভয় স্ট্যাক খালি।
দ্বিতীয় স্ট্যাকের জন্য আমরা এই শর্ত বজায় রাখব যে সকল অপারেশন কঠোর অবনমনশীল অগ্রাধিকার অনুসারে সাজানো।
যদি স্ট্যাকে ব্র্যাকেট থাকে, তাহলে অপারেটরের প্রতিটি ব্লক (এক জোড়া ব্র্যাকেটের সাথে সম্পর্কিত) সাজানো, এবং সম্পূর্ণ স্ট্যাক অগত্যা সাজানো নয়।
...
যদি বর্তমান অক্ষরটি একটি ওপেনিং ব্র্যাকেট হয়, তাহলে আমরা এটা স্ট্যাকে রাখি।
যদি বর্তমান অক্ষরটি একটি ক্লোজিং ব্র্যাকেট হয়, তাহলে আমরা ওপেনিং ব্র্যাকেট না পাওয়া পর্যন্ত স্ট্যাকের সকল অপারেটর কার্যকর করি (অন্য কথায় আমরা ব্র্যাকেটের ভিতরের সকল অপারেশন সম্পাদন করি)।
...
এই ক্ষেত্রে একটি পার্থক্য হলো, আমাদের ডিটারমিন করতে হবে বর্তমান অপারেটরটি ইউনারি নাকি বাইনারি।

তুমি লক্ষ্য করতে পারো যে, একটি ইউনারি অপারেটরের আগে সবসময় অন্য একটি অপারেটর বা একটি ওপেনিং ব্র্যাকেট থাকে, অথবা কিছুই থাকে না (যদি এটা এক্সপ্রেশনের একেবারে শুরুতে থাকে)।
বিপরীতে, একটি বাইনারি অপারেটরের আগে সবসময় একটি অপারেন্ড (সংখ্যা) বা একটি ক্লোজিং ব্র্যাকেট থাকবে।
...
```
যেখানে `left_assoc` হলো এমন একটি ফাংশন যা ডিটারমিন করে একটি অপারেটর লেফট-অ্যাসোসিয়েটিভ কিনা।
