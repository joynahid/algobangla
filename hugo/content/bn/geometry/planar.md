...
একটা গ্রাফ $G$ ধরো যার $n$ টি ভার্টেক্স ও $m$ টি এজ আছে, এবং যেটা সমতলে এমনভাবে আঁকা যায় যে দুটো এজ শুধুমাত্র একটা সাধারণ ভার্টেক্সে (যদি থাকে) ছেদ করে।
এই ধরনের গ্রাফকে **প্ল্যানার** (planar) বলা হয়। এখন ধরো আমাদের একটা প্ল্যানার গ্রাফ তার স্ট্রেট-লাইন এমবেডিং সহ দেওয়া আছে, অর্থাৎ প্রতিটা ভার্টেক্স $v$-এর জন্য আমাদের কাছে একটা বিন্দু $(x, y)$ আছে এবং সব এজ এই বিন্দুগুলোর মধ্যে রেখাখণ্ড হিসেবে ছেদ ছাড়াই আঁকা (এমন এমবেডিং সবসময় বিদ্যমান)। এই রেখাখণ্ডগুলো সমতলকে কয়েকটা অঞ্চলে ভাগ করে, যাদের ফেস (face) বলা হয়। ঠিক একটা ফেস সীমাহীন। এটাকে **বাইরের** ফেস বলা হয়, বাকিগুলোকে **ভেতরের** ফেস বলা হয়।

এই আর্টিকেলে আমরা একটি প্ল্যানার গ্রাফের ভেতরের ও বাইরের উভয় ফেস খুঁজে বের করার বিষয়ে আলোচনা করব। আমরা ধরে নেব গ্রাফটি কানেক্টেড (connected)।

## প্ল্যানার গ্রাফ সম্পর্কে কিছু তথ্য

এই অংশে আমরা প্ল্যানার গ্রাফ সম্পর্কে কিছু তথ্য প্রুফ ছাড়া উপস্থাপন করব। যে পাঠকরা প্রুফে আগ্রহী তাদের [Graph Theory by R. Diestel](https://www.math.uni-hamburg.de/home/diestel/books/graph.theory/preview/Ch4.pdf) (এই বইয়ের উপর ভিত্তি করে [প্ল্যানারিটি সম্পর্কিত ভিডিও লেকচারও](https://www.youtube.com/@DiestelGraphTheory) দেখো) বা অন্য কোনো বই দেখতে পার।

### অয়লারের থিওরেম (theorem)
অয়লারের থিওরেম বলে যে $n$ টি ভার্টেক্স, $m$ টি এজ ও $f$ টি ফেস বিশিষ্ট একটি কানেক্টেড প্ল্যানার গ্রাফের যেকোনো সঠিক এমবেডিং নিচের শর্ত পূরণ করে:

$$n - m + f = 2$$

এবং আরও সাধারণভাবে, $k$ টি কানেক্টেড উপাদান বিশিষ্ট প্রতিটি প্ল্যানার গ্রাফ নিচের শর্ত পূরণ করে:

$$n - m + f = 1 + k$$

### প্ল্যানার গ্রাফের এজ সংখ্যা
যদি $n \ge 3$ হয় তাহলে $n$ ভার্টেক্স বিশিষ্ট প্ল্যানার গ্রাফের সর্বাধিক এজ সংখ্যা $3n - 6$। এই সংখ্যা যেকোনো কানেক্টেড প্ল্যানার গ্রাফে অর্জিত হয় যেখানে প্রতিটি ফেস একটি ত্রিভুজ দ্বারা সীমাবদ্ধ। কমপ্লেক্সিটির দিক থেকে এই তথ্যের অর্থ হলো যেকোনো প্ল্যানার গ্রাফের জন্য $m = O(n)$।
...
এখন গ্রাফটি এভাবে ট্রাভার্স করি। ধরো আমরা $(v, u)$ এজ দিয়ে ভার্টেক্স $u$-তে প্রবেশ করেছি এবং $u$-এর সাজানো অ্যাডজাসেন্সি লিস্টে $(v, u)$-এর পরবর্তী এজ হলো $(u, w)$। তখন পরবর্তী ভার্টেক্স হবে $w$। দেখা যায় যে আমরা যদি কোনো এজ $(v, u)$ থেকে এই ট্রাভার্সাল শুরু করি, আমরা $(v, u)$-র সংলগ্ন ফেসগুলোর ঠিক একটি ট্রাভার্স করব, কোন ফেস তা নির্ভর করবে আমাদের প্রথম পদক্ষেপ $u$ থেকে $v$ নাকি $v$ থেকে $u$।

এখন অ্যালগরিদমটি বেশ স্পষ্ট। আমাদের গ্রাফের সব এজের উপর ইটারেট করতে হবে এবং প্রতিটি এজের জন্য ট্রাভার্সাল শুরু করতে হবে যেটা আগের কোনো ট্রাভার্সালে ভিজিট হয়নি। এভাবে আমরা প্রতিটি ফেস ঠিক একবার পাব, এবং প্রতিটি এজ দুবার ট্রাভার্স হবে (প্রতিটি দিকে একবার)।
...
### কমপ্লেক্সিটি
এটা বেশ স্পষ্ট যে অ্যালগরিদমের কমপ্লেক্সিটি সাজানোর কারণে $O(m \log m)$, এবং যেহেতু $m = O(n)$, এটা আসলে $O(n \log n)$। আগে উল্লেখ করা হয়েছে, সাজানো ছাড়া কমপ্লেক্সিটি $O(n)$ হয়ে যায়।

## গ্রাফ কানেক্টেড না হলে কী হবে?

প্রথম দেখায় মনে হতে পারে যে বিচ্ছিন্ন গ্রাফের ফেস খোঁজা খুব কঠিন নয় কারণ আমরা প্রতিটা কানেক্টেড উপাদানের জন্য একই অ্যালগরিদম চালাতে পারি। তবে, উপাদানগুলো নেস্টেড পদ্ধতিতে আঁকা হতে পারে, **ছিদ্র** (holes) তৈরি করে (নিচের ছবি দেখো)। এই ক্ষেত্রে কোনো উপাদানের ভেতরের ফেস অন্য কোনো উপাদানের বাইরের ফেস হয়ে যায় এবং এর একটি জটিল বিচ্ছিন্ন সীমানা থাকে। এমন ক্ষেত্র সামলানো বেশ কঠিন, একটি সম্ভাব্য পদ্ধতি হলো [পয়েন্ট লোকেশন](point-location.md) অ্যালগরিদম দিয়ে নেস্টেড উপাদান চিহ্নিত করা।

<div style="text-align: center;">
  <img src="/images/geometry/planar_hole.png" alt="Planar graph with holes">
</div>

## ইমপ্লিমেন্টেশন
নিচের ইমপ্লিমেন্টেশন প্রতিটি ফেসের জন্য ভার্টেক্সের একটি ভেক্টর ফেরত দেয়, বাইরের ফেস প্রথমে আসে।
...
কখনো কখনো তোমাকে সরাসরি গ্রাফ দেওয়া হয় না, বরং সমতলে রেখাখণ্ডের একটা সেট দেওয়া হয়, এবং প্রকৃত গ্রাফটি সেই রেখাখণ্ডগুলোর ছেদ থেকে তৈরি হয়, নিচের ছবিতে যেমন দেখানো হয়েছে। এই ক্ষেত্রে তোমাকে ম্যানুয়ালি গ্রাফটা তৈরি করতে হবে। সবচেয়ে সহজ উপায় হলো এরকম। একটা রেখাখণ্ড ধরো এবং এটাকে অন্য সব রেখাখণ্ডের সাথে ছেদ করো। তারপর সব ছেদবিন্দু ও রেখাখণ্ডের দুই প্রান্তবিন্দু লেক্সিকোগ্রাফিক্যালি সাজাও এবং গ্রাফে ভার্টেক্স হিসেবে যোগ করো। এছাড়াও লেক্সিকোগ্রাফিক্যালি প্রতিটা দুটো পরপর ভার্টেক্সকে একটা এজ দিয়ে কানেক্ট করো। সব এজের জন্য এই প্রক্রিয়া কমপ্লিট করলে আমরা গ্রাফটা পাব। অবশ্যই, আমাদের নিশ্চিত করতে হবে যে দুটো সমান ছেদবিন্দু সবসময় একই ভার্টেক্সের সাথে সম্পর্কিত হবে। সবচেয়ে সহজ উপায় হলো বিন্দুগুলো তাদের স্থানাঙ্ক অনুযায়ী একটা ম্যাপে রাখা, যেসব বিন্দুর স্থানাঙ্ক একটা ছোট সংখ্যার (ধরি, $10^{-9}$-এর কম) চেয়ে কম পার্থক্য বিশিষ্ট তাদের সমান ধরে। এই অ্যালগরিদম $O(n^2 \log n)$-এ কাজ করে।

<div style="text-align: center;">
  <img src="/images/geometry/planar_implicit.png" alt="Implicitly defined graph">
</div>
