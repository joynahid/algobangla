---
title: "গ্রাফে কানেক্টেড কম্পোনেন্ট খোঁজা"
tags: 
weight: 10
---
...
* সমস্যা সমাধানের জন্য, আমরা DFS বা BFS ব্যবহার করতে পারি।

* আসলে, আমরা DFS-এর কয়েকটি রাউন্ড চালাব: প্রথম রাউন্ড প্রথম নোড থেকে শুরু হবে এবং প্রথম কানেক্টেড কম্পোনেন্টের সব নোড ট্রাভার্স (খুঁজে পাওয়া) হবে। তারপর বাকি নোডগুলোর মধ্যে প্রথম অভিজিত নোড খুঁজে সেটি থেকে DFS চালাব, এভাবে দ্বিতীয় কানেক্টেড কম্পোনেন্ট পাওয়া যাবে। এভাবে চলতে থাকবে যতক্ষণ না সব নোড ভিজিট করা হয়।
...
* গ্রাফটি অ্যাডজেসেন্সি লিস্ট রিপ্রেজেন্টেশনে স্টোর করা, অর্থাৎ `adj[v]` ভার্টেক্স `v` থেকে এজযুক্ত ভার্টেক্সগুলোর তালিকা ধারণ করে।
...
তাই যখন তুমি লক্ষ লক্ষ নোড বিশিষ্ট কানেক্টেড গ্রাফে রিকার্সিভ DFS চালাও, তুমি স্ট্যাক ওভারফ্লোতে পড়তে পারো।
