...
অ্যালগরিদমের প্রতিটি পুনরাবৃত্তিতে, পারমুটেশন $p[0 \dots n-1]$ ছাড়াও, যেখানে $p[i]$ হল সাজানো ক্রমে $i$-তম সাবস্ট্রিং ($ থেকে শুরু করে এবং দৈর্ঘ্য $2^k$) এর সূচক, আমরা একটি অ্যারে $c[0 \dots n-1]$ ও বজায় রাখব, যেখানে $c[i]$ **সমতুল্য শ্রেণী** এর সাথে সামঞ্জস্যপূর্ণ যাতে সাবস্ট্রিং অন্তর্গত।
