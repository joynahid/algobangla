...
অয়লারের টোশেন্ট ফাংশনের নিচের বৈশিষ্ট্যগুলো যেকোনো সংখ্যার জন্য এটা গণনা করতে যথেষ্ট:
...
$$\phi(p^k) = p^k - p^{k-1}.$$
  ...
  - যদি $a$ ও $b$ পরস্পর সহমৌলিক হয়, তাহলে:
    ...
    এই সম্পর্কটি তুচ্ছভাবে দেখা যায় না। এটা [চাইনিজ রিমেইন্ডার থিওরেম](chinese-remainder-theorem.md) থেকে অনুসৃত হয়। চাইনিজ রিমেইন্ডার থিওরেম নিশ্চিত করে যে, প্রতিটি $0 \le x < a$ এবং প্রতিটি $0 \le y < b$-এর জন্য, একটি অনন্য $0 \le z < a b$ বিদ্যমান যেখানে $z \equiv x \pmod{a}$ এবং $z \equiv y \pmod{b}$। দেখানো কঠিন নয় যে $z$, $a b$-এর সাথে সহমৌলিক যদি এবং কেবল যদি $x$, $a$-এর সাথে সহমৌলিক হয় এবং $y$, $b$-এর সাথে সহমৌলিক হয়। তাই $a b$-এর সাথে সহমৌলিক পূর্ণসংখ্যার সংখ্যা $a$ ও $b$-এর পরিমাণের গুণফলের সমান।

  - সাধারণভাবে, সহমৌলিক নয় এমন $a$ ও $b$-এর জন্য, ইকুয়েশন

    \[\phi(ab) = \phi(a) \cdot \phi(b) \cdot \dfrac{d}{\phi(d)}\]

    যেখানে $d = \gcd(a, b)$, এটা ধরে।

সুতরাং, প্রথম তিনটি বৈশিষ্ট্য ব্যবহার করে, আমরা $n$-এর উৎপাদক বিশ্লেষণ ($n$-কে তার মৌলিক ফ্যাক্টরের গুণফলে বিভাজন) এর মাধ্যমে $\phi(n)$ গণনা করতে পারি।
যদি $n = {p_1}^{a_1} \cdot {p_2}^{a_2} \cdots {p_k}^{a_k}$ হয়, যেখানে $p_i$ হলো $n$-এর মৌলিক ফ্যাক্টর,
...
এটা এখনও উপরে দেখানো বৈশিষ্ট্যের উপর ভিত্তি করে, তবে প্রতিটি সংখ্যার জন্য প্রতিটি মৌলিক ফ্যাক্টরের জন্য অস্থায়ী ফলাফল আপডেট করার বদলে, আমরা সকল মৌলিক সংখ্যা খুঁজে বের করি এবং প্রতিটির জন্য সেই মৌলিক সংখ্যা দ্বারা বিভাজ্য সকল সংখ্যার অস্থায়ী ফলাফল আপডেট করি।
...
অ্যালগরিদমটি প্রথমে $\sqrt{R}$ পর্যন্ত সকল মৌলিক সংখ্যা একটি [লিনিয়ার সিভ](prime-sieve-linear.md) ব্যবহার করে $O(\sqrt{R})$ সময় ও স্থানে প্রিকম্পিউট করে। $[L, R]$ রেঞ্জের প্রতিটি সংখ্যার জন্য, এটা এই মৌলিক সংখ্যাগুলোর উপর ইটারেট করে উৎপাদক বিশ্লেষণ-ভিত্তিক $\phi$ সূত্র প্রয়োগ করে। আমরা প্রতিটি সংখ্যার অবিশ্লেষিত অংশ ট্র্যাক করতে একটি রিমেইন্ডার অ্যারে রাখি। সকল ছোট মৌলিক প্রক্রিয়া করার পরও যদি একটি রিমেইন্ডার ১-এর বেশি থাকে, তাহলে এটা $\sqrt{R}$-এর চেয়ে বড় একটি মৌলিক ফ্যাক্টর বোঝায়, যা চূড়ান্ত পাসে হ্যান্ডেল করা হয়। রেঞ্জ গণনার সামগ্রিক কমপ্লেক্সিটি $O((R - L + 1) \log \log R) + \sqrt{R}$।
...
## ডিভাইজরের যোগফল বৈশিষ্ট্য { #divsum}

এই আকর্ষণীয় বৈশিষ্ট্যটি গাউস প্রতিষ্ঠা করেছিলেন:

$$ \sum_{d|n} \phi{(d)} = n$$

এখানে যোগফল $n$-এর সকল ধনাত্মক ডিভাইজর $d$-এর উপর।

উদাহরণস্বরূপ ১০-এর ডিভাইজরগুলো হলো ১, ২, ৫ ও ১০।
তাই $\phi{(1)} + \phi{(2)} + \phi{(5)} + \phi{(10)} = 1 + 1 + 4 + 4 = 10$।

### ডিভাইজরের যোগফল বৈশিষ্ট্য ব্যবহার করে ১ থেকে $n$ পর্যন্ত টোশেন্ট নির্ণয় { data-toc-label="Finding the totient from 1 to n using the divisor sum property" }

ডিভাইজরের যোগফল বৈশিষ্ট্য আমাদের ১ থেকে $n$-এর মধ্যে সকল সংখ্যার টোশেন্ট গণনা করতেও দেয়।
...
## অয়লারের থিওরেমে প্রয়োগ { #application }

অয়লারের টোশেন্ট ফাংশনের সবচেয়ে বিখ্যাত ও গুরুত্বপূর্ণ বৈশিষ্ট্য **অয়লারের থিওরেমে** প্রকাশিত:

$$a^{\phi(m)} \equiv 1 \pmod m \quad \text{if } a \text{ and } m \text{ are relatively prime.}$$

বিশেষ ক্ষেত্রে যখন $m$ মৌলিক, অয়লারের থিওরেম **ফার্মার ক্ষুদ্র থিওরেমে** পরিণত হয়:

$$a^{m - 1} \equiv 1 \pmod m$$

অয়লারের থিওরেম ও অয়লারের টোশেন্ট ফাংশন ব্যবহারিক প্রয়োগে বেশ ঘন ঘন দেখা যায়, উদাহরণস্বরূপ উভয়ই [মডুলার গুণনীয় বিপরীত](module-inverse.md) গণনায় ব্যবহৃত হয়।

তাৎক্ষণিক ফলাফল হিসেবে আমরা এই সমতুল্যতাও পাই:

$$a^n \equiv a^{n \bmod \phi(m)} \pmod m$$

এটা অত্যন্ত বড় $n$-এর জন্য $x^n \bmod m$ গণনা করতে দেয়, বিশেষত যদি $n$ অন্য কোনো গণনার ফলাফল হয়, কারণ এটা একটি মডুলোর অধীনে $n$ গণনা করতে দেয়।
...
মনে করি $p_1, \dots, p_t$ হলো $x$ ও $m$-এর সাধারণ মৌলিক ডিভাইজর, এবং $k_i$ হলো $m$-এ তাদের সূচক।
এগুলো দিয়ে ডিফাইন করা করি $a = p_1^{k_1} \dots p_t^{k_t}$, যা $\frac{m}{a}$-কে $x$-এর সাথে সহমৌলিক করে।
...
আসলে যদি $b = cd + r$ যেখানে $r < c$, তাহলে $ab = acd + ar$ যেখানে $ar < ac$।

যেহেতু $x$ ও $\frac{m}{a}$ সহমৌলিক, আমরা অয়লারের থিওরেম প্রয়োগ করে দক্ষ সূত্র পাই (যেহেতু $k$ অত্যন্ত ছোট; আসলে $k \le \log_2 m$):

$$x^n \bmod m = x^k\left(x^{n-k \bmod \phi(\frac{m}{a})} \bmod \frac{m}{a}\right)\bmod m.$$

এই সূত্রটি প্রয়োগ করা কঠিন, তবে আমরা এটা $x^n \bmod m$-এর আচরণ বিশ্লেষণে ব্যবহার করতে পারি। দেখা যায় ঘাতের ক্রম $(x^1 \bmod m, x^2 \bmod m, x^3 \bmod m, \dots)$ প্রথম $k$টি (বা কম) উপাদানের পর $\phi\left(\frac{m}{a}\right)$ দৈর্ঘ্যের একটি চক্রে প্রবেশ করে।
