---
title: "স্টার্ন-ব্রকট ট্রি এবং ফ্যারে সিকোয়েন্স"
tags: 
weight: 40
---
...
যেখানে লক্ষণীয় যে দ্বিতীয় রাশিটি কঠোরভাবে একটি ফ্র্যাকশন নয়, কিন্তু এটাকে অসীমকে উপস্থাপনকারী একটি অপরিবর্তনীয় ফ্র্যাকশন হিসেবে ব্যাখ্যা করা যেতে পারে।

প্রতিটি পরবর্তী ইটারেশনে, সমস্ত সন্নিহিত ফ্র্যাকশন $\frac{a}{b}$ এবং $\frac{c}{d}$ ধরো এবং তাদের মধ্যে তাদের [মিডিয়ান্ট](https://en.wikipedia.org/wiki/Mediant_(mathematics)) $\frac{a+c}{b+d}$ ইনসার্শন করো।
...
এই প্রক্রিয়াটি অসীম পর্যন্ত চালিয়ে গেলে এটা *সমস্ত* ধনাত্মক ফ্র্যাকশন কভার করে। অতিরিক্তভাবে, সমস্ত ফ্র্যাকশন *অনন্য* এবং *অপরিবর্তনীয়* হবে। পরিশেষে, ফ্র্যাকশনগুলো ঊর্ধ্বক্রমেও প্রদর্শিত হবে।
...
দুটি অসমতাই সাধারণ হর দিয়ে ফ্র্যাকশনগুলো পুনঃলিখন করে সহজেই দেখানো যায়।
...
মনে রাখো যে দুটি চলকের একটি ডায়োফ্যান্টাইন ইকুয়েশন $ax+by=c$-এর সমাধান থাকে যদি এবং কেবল যদি $c$, $\gcd(a,b)$-এর গুণিতক হয়। আমাদের ক্ষেত্রে এটা বোঝায় যে $\gcd(a,b) = \gcd(c,d) = 1$, যা আমরা দেখাতে চাই।
...
এটা বিস্তৃত করে এবং আগে দেখানো $bc-ad=1$ বৈশিষ্ট্য ব্যবহার করে আমরা পাই

$$
    x+y \ge a+b+c+d.
$$

এবং যেহেতু প্রতিটি ইটারেশনে $a,b,c,d$-এর অন্তত একটি বাড়বে, তাই ফ্র্যাকশন সার্চ প্রক্রিয়ায় $x+y$-এর বেশি ইটারেশন থাকবে না। এটা $\frac{x}{y}$-এ যাওয়ার পথ অসীম ছিল এমন ধারণার সাথে সাংঘর্ষিক এবং তাই $\frac{x}{y}$ অবশ্যই ট্রি-র অংশ।
...
এমনভাবে যে $\frac{p_{k-1}}{q_{k-1}}$ এবং $\frac{p_k}{q_k}$ হলো $k$-তম ধাপে সার্চ ব্যবধানের সীমানা, $\frac{p_0}{q_0} = \frac{0}{1}$ এবং $\frac{p_1}{q_1} = \frac{1}{0}$ দিয়ে শুরু করে। তারপর, $k$-তম ধাপের পরে আমরা একটি ফ্র্যাকশনে পৌঁছাই

$$
\frac{p_{k+1}}{q_{k+1}} = \frac{p_{k-1} + a_k p_k}{q_{k-1} + a_k q_k},
$$

যেখানে $a_k$ একটি ধনাত্মক পূর্ণসংখ্যা। তুমি যদি [সন্তত ফ্র্যাকশন](../algebra/continued-fractions.md)-এর সাথে পরিচিত হও, তাহলে চিনতে পারবে যে $\frac{p_i}{q_i}$ সিকোয়েন্সটি হলো $\frac{p}{q}$-এর অভিসারী ফ্র্যাকশনের সিকোয়েন্স এবং $[a_1; a_2, \dots, a_{n}, 1]$ সিকোয়েন্সটি $\frac{p}{q}$-এর সন্তত ফ্র্যাকশন উপস্থাপনা।
