---
title: "গসাগু (গরিষ্ঠ সাধারণ ফ্যাক্টর) নির্ণয়ের ইউক্লিডীয় অ্যালগরিদম"
tags: 
weight: 20
---
# গসাগু (গরিষ্ঠ সাধারণ ফ্যাক্টর) নির্ণয়ের ইউক্লিডীয় অ্যালগরিদম

দুটি অঋণাত্মক পূর্ণ সংখ্যা $a$ ও $b$ দেওয়া আছে, আমাদের এদের **জিসিডি** (গরিষ্ঠ সাধারণ ফ্যাক্টর বা গসাগু) বের করতে হবে, অর্থাৎ সেই বৃহত্তম সংখ্যা যা $a$ ও $b$ উভয়ের ফ্যাক্টর।
একে সাধারণত $\gcd(a, b)$ দ্বারা প্রকাশ করা হয়। গাণিতিকভাবে এটা এভাবে ডিফাইন করা:
...
লক্ষ্য করো যে C++১৭ থেকে `gcd` একটি [স্ট্যান্ডার্ড ফাংশন](https://en.cppreference.com/w/cpp/numeric/gcd) হিসেবে C++-এ ইমপ্লিমেন্ট করা আছে।
...
সুতরাং, ইউক্লিডীয় অ্যালগরিদম ব্যবহার করে একই টাইম কমপ্লেক্সিটিতে LCM নির্ণয় করা যায়:
...
এটা কয়েকটি বৈশিষ্ট্যের উপর ভিত্তি করে:
