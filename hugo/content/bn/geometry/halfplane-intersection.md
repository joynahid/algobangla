...
এই আর্টিকেলে আমরা হাফ-প্লেনগুলোর একটি সেটের ছেদ (intersection) নির্ণয়ের সমস্যা নিয়ে আলোচনা করব। এই ধরনের ছেদকে সুবিধাজনকভাবে একটা কনভেক্স (convex) অঞ্চল/পলিগন হিসেবে রিপ্রেজেন্ট করা যায়, যেখানে এর ভেতরের প্রতিটি বিন্দু সব হাফ-প্লেনের ভেতরেও অবস্থান করে, এবং এই পলিগনটিই আমরা খুঁজে বের করতে বা নির্মাণ করতে চাই। আমরা সমস্যাটির কিছু প্রাথমিক ধারণা দেব, সর্ট-অ্যান্ড-ইনক্রিমেন্টাল অ্যালগরিদম নামে পরিচিত একটি $O(N \log N)$ পদ্ধতি বর্ণনা করব এবং এই টেকনিকের কিছু নমুনা প্রয়োগ দেখাব।

পাঠকের জন্য মৌলিক জ্যামিতিক প্রিমিটিভ (primitives) আর অপারেশন (বিন্দু, ভেক্টর, সরলরেখার ছেদ) সম্পর্কে পরিচিত থাকা জোরালোভাবে রেকমেন্ড করা হচ্ছে। এছাড়াও, [কনভেক্স হাল](../geometry/convex-hull.md) বা [কনভেক্স হাল ট্রিক](../geometry/convex_hull_trick.md) সম্পর্কে জ্ঞান থাকলে এই আর্টিকেলের ধারণাগুলো আরও ভালোভাবে বুঝতে সাহায্য করতে পারে, তবে এগুলো কোনোভাবেই পূর্বশর্ত নয়।

## প্রাথমিক ব্যাখ্যা ও সংজ্ঞা

পুরো আর্টিকেল জুড়ে, আমরা কিছু অনুমান করব (অন্যথায় উল্লেখ না করা হলে):

১. আমরা দেওয়া সেটে হাফ-প্লেনের সংখ্যাকে $N$ দ্বারা ডিফাইন করব।
২. আমরা সরলরেখা এবং হাফ-প্লেনকে একটি বিন্দু এবং একটি ভেক্টর দিয়ে উপস্থাপন করব (দেওয়া সরলরেখার উপর অবস্থিত যেকোনো বিন্দু, এবং সরলরেখার দিক ভেক্টর)। হাফ-প্লেনের ক্ষেত্রে, আমরা ধরে নিই যে প্রতিটি হাফ-প্লেন তার দিক ভেক্টরের বাম দিকের অঞ্চল অনুমোদন করে। এছাড়াও, আমরা একটি হাফ-প্লেনের কোণকে তার দিক ভেক্টরের পোলার কোণ হিসেবে ডিফাইন করি। উদাহরণের জন্য নিচের ছবিটি দেখুন।
৩. আমরা ধরে নেব যে ফলে পাওয়া ছেদ সবসময় হয় সীমাবদ্ধ (bounded) অথবা শূন্য (empty)। যদি আমাদের অসীমাবদ্ধ ক্ষেত্র সামলাতে হয়, তাহলে আমরা সহজেই ৪টি হাফ-প্লেন যোগ করতে পারি যা একটি যথেষ্ট বড় বাউন্ডিং বক্স ডিফাইন করে।
৪. সরলতার জন্য আমরা ধরে নেব যে দেওয়া সেটে কোনো সমান্তরাল হাফ-প্লেন নেই। আর্টিকেলের শেষের দিকে আমরা এই ধরনের ক্ষেত্র কীভাবে সামলাতে হয় তা আলোচনা করব।
...
এটি কেন কাজ করে তা দেখা বেশ সহজ: ফলে পাওয়া উত্তল পলিগনের ভার্টেক্সগুলো সব হাফ-প্লেন সরলরেখার ছেদবিন্দু, এবং সেই ভার্টেক্সগুলোর প্রতিটি স্পষ্টতই সব হাফ-প্লেনের অংশ। এই পদ্ধতির প্রধান সুবিধা হলো এটি বোঝা, মনে রাখা এবং তাৎক্ষণিকভাবে কোড করা সহজ যদি তুমি শুধু ছেদ শূন্য কি না সেটা চেক করতে চাও। তবে, এটি ভয়ানক ধীর এবং বেশিরভাগ সমস্যার জন্য অনুপযুক্ত, তাই আমাদের আরও দ্রুত কিছু দরকার।
...
৩. ছেদ শূন্য হয়ে যেতে পারে (কেস ১ এবং/অথবা ২ সামলানোর পরে)। এই ক্ষেত্রে, আমরা শুধু রিপোর্ট করি যে ছেদ শূন্য এবং অ্যালগরিদম শেষ করি।

*আমরা বলি একটি হাফ-প্লেন "অপ্রয়োজনীয়" যদি এটি ছেদে কিছুই অবদান না রাখে। এরকম একটি হাফ-প্লেন সরিয়ে ফেললেও ফলে পাওয়া ছেদ মোটেই পরিবর্তন হবে না।*

এখানে একটি ছোট উদাহরণ সচিত্রে দেওয়া হলো:

ধরি $H = \{ A, B, C, D, E \}$ হলো বর্তমানে ছেদে উপস্থিত হাফ-প্লেনের সেট। এছাড়াও, ধরি $P = \{ p, q, r, s \}$ হলো H-তে পাশাপাশি হাফ-প্লেনগুলোর ছেদবিন্দুর সেট। এখন, ধরো আমরা এটাকে হাফ-প্লেন $F$ দিয়ে ছেদ করতে চাই, যেমনটা নিচের চিত্রে দেখানো হয়েছে:

![](/images/geometry/halfplanes_hp1.png)

লক্ষ্য করো, হাফ-প্লেন $F$ ছেদে $A$ আর $E$-কে অপ্রয়োজনীয় করে তোলে। তাই আমরা ছেদের সামনে এবং পেছন থেকে যথাক্রমে $A$ এবং $E$ সরিয়ে ফেলি, এবং শেষে $F$ যোগ করি। এবং আমরা অবশেষে নতুন ছেদ $H = \{ B, C, D, F\}$ পাই যেখানে $P = \{ q, r, t, u \}$।
...
সংক্ষেপে, পূর্ণ অ্যালগরিদমটি মোটামুটি এরকম হবে:

১. আমরা হাফ-প্লেনের সেটকে কোণ অনুসারে সর্ট করে শুরু করি, যাতে $O(N \log N)$ সময় লাগে।
২. আমরা হাফ-প্লেনের সেটের উপর ইটারেট করব, এবং প্রতিটির জন্য, আমরা ইনক্রিমেন্টাল প্রক্রিয়া করব, প্রয়োজনমতো ডাবল-এন্ডেড কিউয়ের সামনে এবং পেছন থেকে পপ করব। এটি মোট রৈখিক সময় নেবে, কারণ প্রতিটি হাফ-প্লেন মাত্র একবার যোগ বা সরানো যেতে পারে।
৩. শেষে, ছেদ থেকে ফলে পাওয়া উত্তল পলিগনটি সহজেই পাওয়া যায় প্রক্রিয়ার শেষে ডেকের পাশাপাশি হাফ-প্লেনগুলোর ছেদবিন্দু গণনা করে। এটিও রৈখিক সময় নেবে। ধাপ ২-এর সময় এই বিন্দুগুলো সংরক্ষণ করা এবং এই ধাপটি সম্পূর্ণ এড়িয়ে যাওয়াও সম্ভব, কিন্তু আমরা মনে করি (ইমপ্লিমেন্টেশনের দিক থেকে) সেগুলো তাৎক্ষণিকভাবে গণনা করা কিছুটা সহজ।

মোটের উপর, আমরা $O(N \log N)$ টাইম কমপ্লেক্সিটি অর্জন করেছি। যেহেতু সর্টিং স্পষ্টতই বটলনেক, অ্যালগরিদমটি রৈখিক সময়ে চালানো যায় সেই বিশেষ ক্ষেত্রে যেখানে আমাদের কোণ অনুসারে আগে থেকেই সর্ট করা হাফ-প্লেন দেওয়া হয় (এই ধরনের ক্ষেত্রের একটি উদাহরণ হলো একটি উত্তল পলিগন ডিফাইন করা হাফ-প্লেনগুলো পাওয়া)।
...
একটি বিশেষ বিষয় লক্ষণীয় যে, যদি একাধিক হাফ-প্লেন একই বিন্দুতে ছেদ করে, তাহলে এই অ্যালগরিদম চূড়ান্ত পলিগনে পুনরাবৃত্ত পাশাপাশি বিন্দু রিটার্ন করতে পারে। তবে, ছেদ শূন্য কি না তা সঠিকভাবে বিচার করার উপর এর কোনো প্রভাব থাকা উচিত নয়, এবং এটি পলিগনের ক্ষেত্রফলকেও মোটেই প্রভাবিত করে না। পরবর্তীতে কী কাজ করতে হবে তার উপর নির্ভর করে তুমি এই ডুপ্লিকেটগুলো সরাতে চাইতে পারো। তুমি std::unique দিয়ে খুব সহজেই এটা করতে পারো। আমরা অ্যালগরিদম চলার সময় ডুপ্লিকেট বিন্দুগুলো রাখতে চাই যাতে শূন্য ক্ষেত্রফলের ছেদগুলো সঠিকভাবে গণনা করা যায় (যেমন, যে ছেদগুলো একটা একক বিন্দু, সরলরেখা বা রেখাংশ নিয়ে গঠিত)। তোমাকে কিছু ছোট হাতে তৈরি কেস টেস্ট করতে উৎসাহিত করা হচ্ছে যেখানে ছেদ একটা একক বিন্দু বা সরলরেখায় পরিণত হয়।

আরও একটি বিষয় যা বলা উচিত তা হলো যদি আমাদের রৈখিক সীমাবদ্ধতার আকারে হাফ-প্লেন দেওয়া হয় (উদাহরণস্বরূপ, $ax + by + c \leq 0$) তাহলে কী করতে হবে। এই ক্ষেত্রে, দুটি বিকল্প আছে। তুমি হয় এই ধরনের রিপ্রেজেন্টেশনের সাথে কাজ করার জন্য প্রয়োজনীয় পরিবর্তনসহ অ্যালগরিদমটা ইমপ্লিমেন্ট করতে পারো (মূলত তোমার নিজের হাফ-প্লেন স্ট্রাক্ট বানাও, কনভেক্স হাল ট্রিকের সাথে পরিচিত থাকলে এটা মোটামুটি সরল হওয়া উচিত), অথবা তুমি প্রতিটা সরলরেখার যেকোনো ২টা বিন্দু নিয়ে এই আর্টিকেলে ব্যবহৃত রিপ্রেজেন্টেশনে সরলরেখাগুলো কনভার্ট করতে পারো। সাধারণত, অতিরিক্ত নির্ভুলতার সমস্যা এড়াতে সমস্যায় যে উপস্থাপনা দেওয়া আছে তা দিয়েই কাজ করা সুপারিশ করা হয়।
...
সমতলে বিন্দুগুলোর একটি সেট $p$ ($p_1, p_2\ \dots \ p_n$) দেওয়া আছে, বের করো যে এমন কোনো বিন্দু $q$ আছে কি না যেখানে দাঁড়িয়ে তুমি $p$-এর সব বিন্দুকে তাদের ইনডেক্সের ক্রমবর্ধমান ক্রমে বাম থেকে ডানে দেখতে পাবে।

এই সমস্যাটি লক্ষ্য করে সমাধান করা যায় যে কোনো বিন্দু $p_i$-কে $p_j$-এর বামে দেখতে পাওয়া মানে $p_i$ থেকে $p_j$ পর্যন্ত রেখাংশের ডান দিক দেখতে পাওয়া (বা সমতুল্যভাবে, $p_j$ থেকে $p_i$ পর্যন্ত সেগমেন্টের বাম দিক দেখতে পাওয়া)। এটি মাথায় রেখে, আমরা সহজেই প্রতিটি রেখাংশ $p_i p_{i+1}$ (বা $p_{i+1} p_i$, তুমি কোন ওরিয়েন্টেশন বেছে নাও তার উপর নির্ভর করে) এর জন্য একটি হাফ-প্লেন তৈরি করতে পারি এবং পুরো সেটের ছেদ শূন্য কি না তা পরীক্ষা করতে পারি।
...
* 40th Petrozavodsk Programming Camp, Winter 2021 - Day 1: Jagiellonian U Contest, Grand Prix of Krakow - Problem B: (Almost) Fair Cake-Cutting। এই আর্টিকেল লেখার সময়, এই সমস্যাটি ব্যক্তিগত ছিল এবং শুধুমাত্র প্রোগ্রামিং ক্যাম্পের অংশগ্রহণকারীদের জন্য রিচেবল ছিল।
