...
**কন্টিনিউড ফ্র্যাকশন** (continued fraction) হলো একটি বাস্তব সংখ্যাকে মূলদ সংখ্যাগুলোর একটি নির্দিষ্ট কনভার্জেন্ট অনুক্রম হিসাবে উপস্থাপন করা। প্রতিযোগিতামূলক প্রোগ্রামিং-এ এগুলো দরকারি কারণ এগুলো গণনা করা সহজ এবং বাস্তব সংখ্যার সেরা সম্ভাব্য মূলদ আনুমানিক খুঁজে পেতে দক্ষতার সাথে ব্যবহার করা যায় (সেই সব সংখ্যার মধ্যে যাদের হর একটা দেওয়া মানকে অতিক্রম করে না)।

এর পাশাপাশি, কন্টিনিউড ফ্র্যাকশন ইউক্লিডীয় অ্যালগরিদমের সাথে ঘনিষ্ঠভাবে সম্পর্কিত, যেটা এদেরকে অনেক সংখ্যা-তাত্ত্বিক সমস্যায় দরকারি করে তোলে।
...
কে মূলদ সংখ্যা $r$ এর **কন্টিনিউড ফ্র্যাকশন রিপ্রেজেন্টেশন** বলা হয় এবং এটাকে সংক্ষেপে $r=[a_0;a_1,a_2,\dots,a_k]$ হিসাবে লেখা হয়।
{{< /hint >}}
??? উদাহরণ
    ধরি $r = \frac{5}{3}$। এটাকে কন্টিনিউড ফ্র্যাকশন হিসাবে রিপ্রেজেন্ট করার দুটি উপায় আছে:
...
এটা প্রুফ করা যায় যে যেকোনো মূলদ সংখ্যাকে ঠিক $2$ উপায়ে কন্টিনিউড ফ্র্যাকশন হিসাবে রিপ্রেজেন্ট করা যায়:
...
{{< /details >}}
{{< hint info >}}
**Linear fractional transformation of a continued fraction**
