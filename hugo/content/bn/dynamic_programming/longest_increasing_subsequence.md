...
ফর্মালি আমরা ইনডেক্সের দীর্ঘতম ক্রম $i_1, \dots i_k$ খুঁজি যেন

$$i_1 < i_2 < \dots < i_k,\quad
a[i_1] < a[i_2] < \dots < a[i_k]$$

এই আর্টিকেলে আমরা এই কাজটা সমাধানের জন্য একাধিক অ্যালগরিদম আলোচনা করব।
এছাড়াও আমরা কিছু অন্যান্য সমস্যা আলোচনা করব, যেগুলো এই সমস্যায় রিডিউস করা যায়।
...
প্রথমে আমরা শুধু দীর্ঘতম ক্রমবর্ধমান সাবসিকোয়েন্সের **দৈর্ঘ্য** খুঁজব, এবং পরে শিখব কীভাবে সাবসিকোয়েন্সটি রিকভার করতে হয়।

### দৈর্ঘ্য বের করা

এই কাজ করতে, আমরা একটা অ্যারে $d[0 \dots n-1]$ ডিফাইন করি, যেখানে $d[i]$ হলো $i$ ইনডেক্সের উপাদানে শেষ হওয়া দীর্ঘতম ক্রমবর্ধমান সাবসিকোয়েন্সের দৈর্ঘ্য।
...
তাহলে ধরো বর্তমান ইনডেক্স $i$।
মানে আমরা $d[i]$-র মান হিসাব করতে চাই এবং আগের সব মান $d[0], \dots, d[i-1]$ ইতিমধ্যে জানা।
...
এখানে উপরে দেখানো অ্যালগরিদমের একটা ইমপ্লিমেন্টেশন দেওয়া হলো, যেটা দীর্ঘতম ক্রমবর্ধমান সাবসিকোয়েন্সের দৈর্ঘ্য হিসাব করে।
...
### সাবসিকোয়েন্স রিকভার

এখনো পর্যন্ত আমরা শুধু সাবসিকোয়েন্সের দৈর্ঘ্য বের করতে শিখেছি, সাবসিকোয়েন্সটি নিজে নয়।

সাবসিকোয়েন্স রিকভার করতে আমরা একটি অতিরিক্ত সহায়ক অ্যারে $p[0 \dots n-1]$ তৈরি করি যা $d[]$ অ্যারের পাশাপাশি হিসাব করব।
...
এই সহায়ক অ্যারে $p[]$ কোনো অর্থে পূর্বসূরীদের দিকে পয়েন্ট করে।
...
### রিকভারের ইমপ্লিমেন্টেশন

আমরা আগের অনুচ্ছেদের কোড কিছুটা পরিবর্তন করব।
আমরা $d[]$-র পাশাপাশি $p[]$ অ্যারে হিসাব করব, এবং তারপর সাবসিকোয়েন্স হিসাব করব।

সুবিধার জন্য আমরা শুরুতে পূর্বসূরীদের $p[i] = -1$ রাখি।
$d[i] = 1$ এমন উপাদানের জন্য, পূর্বসূরীর মান $-1$ থাকবে, যা সাবসিকোয়েন্স রিকভারে কিছুটা সুবিধাজনক।
...
### সাবসিকোয়েন্স রিকভারের বিকল্প উপায়

সহায়ক অ্যারে $p[]$ ছাড়াও সাবসিকোয়েন্স রিকভার করা সম্ভব।
...
শুরুতে আমরা ধরি $d[0] = -\infty$ এবং অন্য সব দৈর্ঘ্যের জন্য $d[l] = \infty$।

আমরা আবার ধাপে ধাপে সংখ্যাগুলো প্রসেস করব, প্রথমে $a[0]$, তারপর $a[1]$, ইত্যাদি, এবং প্রতিটা ধাপে $d[]$ অ্যারে আপডেট রাখব।
...
লক্ষ্য করো, অ্যারের মান সবসময় শেষে পরিবর্তিত হয় না।
...
আগের পদ্ধতির মতো, যদি আমরা $l$ দৈর্ঘ্যের দীর্ঘতম ক্রমবর্ধমান ক্রম থেকে $a[i]$ সরাই, তাহলে $l -1$ দৈর্ঘ্যের আরেকটি দীর্ঘতম ক্রমবর্ধমান ক্রম পাই।
...
১.  $d$ অ্যারে সবসময় সাজানো থাকবে:
    ...
    এটা তুচ্ছ, কারণ তুমি $l$ দৈর্ঘ্যের ক্রমবর্ধমান সাবসিকোয়েন্স থেকে শেষ উপাদান সরাতে পারো, এবং $l-1$ দৈর্ঘ্যের একটা ক্রমবর্ধমান সাবসিকোয়েন্স পাও যেটা আরো ছোট সংখ্যায় শেষ হয়।
...
এই পদ্ধতিতেও সাবসিকোয়েন্স রিকভার করা সম্ভব।
...
$p[i]$ হবে $i$ উপাদানে শেষ হওয়া অপটিমাল সাবসিকোয়েন্সের আগের উপাদানের ইনডেক্স।

$a[]$ অ্যারের উপর ইটারেশনের সময় $d[]$-র হিসাবের পাশাপাশি এই দুটি অ্যারে রাখা সহজ।
এবং শেষে এই অ্যারেগুলো ব্যবহার করে কাঙ্ক্ষিত সাবসিকোয়েন্স রিকভার করা কঠিন নয়।

## ডাটা স্ট্রাকচার দিয়ে $O(n \log n)$ সমাধান {data-toc-label="Solution in O(n log n) with data structures"}

$O(n \log n)$-এ দীর্ঘতম ক্রমবর্ধমান সাবসিকোয়েন্স হিসাবের উপরের পদ্ধতির বদলে আমরা সমস্যাটা ভিন্নভাবেও সমাধান করতে পারি: কিছু সাধারণ ডাটা স্ট্রাকচার (data structure) ব্যবহার করে।

চলো প্রথম পদ্ধতিতে ফিরে যাই।
মনে রেখো $d[i]$ হলো $j < i$ এবং $a[j] < a[i]$ সহ $d[j] + 1$ মান।

তাই যদি আমরা একটা অতিরিক্ত অ্যারে $t[]$ ডিফাইন করি যেন
...
একটা অ্যারের (যেটা পরিবর্তিত হয়) প্রিফিক্সের সর্বোচ্চ খোঁজার সমস্যা একটা স্ট্যান্ডার্ড সমস্যা যেটা বিভিন্ন ডাটা স্ট্রাকচার দিয়ে সমাধান করা যায়।
উদাহরণস্বরূপ আমরা একটা [সেগমেন্ট ট্রি](../data_structures/segment_tree.md) বা একটা [ফেনউইক ট্রি](../data_structures/fenwick.md) ব্যবহার করতে পারি।
...
এছাড়াও ইনপুট সংখ্যা $a[i]$ বিশেষভাবে বড় হলে, কিছু কৌশল ব্যবহার করতে হবে, যেমন কোঅর্ডিনেট কম্প্রেশন (coordinate compression, মানে $0$ থেকে $n-1$ পর্যন্ত পুনঃনম্বরায়ন), অথবা ডায়নামিক সেগমেন্ট ট্রি ব্যবহার করতে হবে (কেবল ট্রির গুরুত্বপূর্ণ শাখাগুলো তৈরি করা)।
...
এবং এই পদ্ধতি আমাদের সমস্যাটা খুব সহজে জেনারেলাইজ করতে দেয় (নিচে দেখো)।
...
$n$ সংখ্যা $a[0 \dots n - 1]$ বিশিষ্ট একটা দেওয়া অ্যারের জন্য আমাদের সংখ্যাগুলোকে ন্যূনতম সংখ্যক রঙে রঙ করতে হবে, যাতে প্রতিটি রঙ একটি অ-বর্ধমান সাবসিকোয়েন্স গঠন করে।

এটি সমাধান করতে, আমরা লক্ষ্য করি যে প্রয়োজনীয় রঙের ন্যূনতম সংখ্যা দীর্ঘতম ক্রমবর্ধমান সাবসিকোয়েন্সের দৈর্ঘ্যের সমান।

**প্রুফ**:
আমাদের এই দুটি সমস্যার **দ্বৈততা** প্রুফ করতে হবে।
...
ধরি $y > x$।
তাহলে আমরা $y$টি অ-বর্ধমান সাবসিকোয়েন্সের যেকোনো অপটিমাল সেট কনসিডার করি।
আমরা এই সেটকে এভাবে রূপান্তরিত করি:
...
মানে বাম থেকে ডানে যাও এবং বর্তমান সংখ্যাটা সেই সাবসিকোয়েন্সে অ্যাসাইন করো যেটা ন্যূনতম সংখ্যায় শেষ হয়েছে যেটা বর্তমান সংখ্যার চেয়ে বড় বা সমান।
