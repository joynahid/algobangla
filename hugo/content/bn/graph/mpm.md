---
title: "ম্যাক্সিমাম ফ্লো - এমপিএম অ্যালগরিদম"
tags: 
weight: 50
---
...
লেয়ারড নেটওয়ার্ক $L$ কনসিডার করো।
প্রতিটি নোডের জন্য আমরা এর _ইনার পটেনশিয়াল_ ও _আউটার পটেনশিয়াল_ এভাবে ডিফাইন করি:
...
$p_{in}$ ও $p_{out}$ দেওয়া থাকলে আমরা _পটেনশিয়াল_ ডিফাইন করি $p(v) = min(p_{in}(v), p_{out}(v))$ হিসেবে।
আমরা একটি নোড $r$-কে _রেফারেন্স নোড_ বলি যদি $p(r) = min\{p(v)\}$ হয়।
একটি রেফারেন্স নোড $r$ কনসিডার করো।
...
প্রতিটি ফেজ $O(V^2)$-এ কাজ করে কারণ সর্বাধিক $V$টি ইটারেশন হয় (কারণ অন্তত সিলেক্টেড রেফারেন্স নোডটি মুছে যায়), এবং প্রতিটি ইটারেশনে আমরা সর্বাধিক $V$টি ব্যতীত যত এজ দিয়ে যাই সব মুছে ফেলি।
যোগফল করলে, আমরা পাই $O(V^2 + E) = O(V^2)$।
যেহেতু $V$-এর কম ফেজ আছে (প্রুফ দেখুন [এখানে](dinic.md)), এমপিএম মোট $O(V^3)$-এ কাজ করে।
