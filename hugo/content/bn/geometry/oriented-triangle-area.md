...
## গণনা
আমরা এই তথ্য ব্যবহার করতে পারি যে একটা $2\times 2$ ম্যাট্রিক্সের ডিটারমিন্যান্ট (determinant) ম্যাট্রিক্সের কলাম (বা সারি) ভেক্টর দ্বারা বিস্তৃত সামান্তরিকের signed ক্ষেত্রফলের সমান।
এটা ২D-তে ক্রস প্রোডাক্টের সংজ্ঞার সাদৃশ্য (দেখো [বেসিক জিওমেট্রি](basic-geometry.md))।
এই ক্ষেত্রফলকে দুই দিয়ে ভাগ করলে আমরা ত্রিভুজের ক্ষেত্রফল পাই যেটা আমাদের দরকার।
