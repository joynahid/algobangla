...
এই আর্টিকেলে আমরা সব $K$-কম্বিনেশন জেনারেট করার সমস্যা আলোচনা করব।
প্রাকৃতিক সংখ্যা $N$ এবং $K$ দেওয়া আছে, এবং $1$ থেকে $N$ পর্যন্ত সংখ্যার একটি সেট কনসিডার করা হচ্ছে।
...
বর্তমান কম্বিনেশন কনসিডার করি এবং সবচেয়ে ডানদিকের সেই উপাদানটি খুঁজি যেটাএখনও তার সর্বোচ্চ সম্ভাব্য মানে পৌঁছায়নি। এই
উপাদানটি পাওয়ার পর, আমরা এটা$1$ বাড়াই এবং পরবর্তী সব
...
এটা[গ্রে কোড](../algebra/gray-code.md) ব্যবহার করে সমাধান করা যায়:
...
$0$ থেকে $2^N - 1$ পর্যন্ত সংখ্যার জন্য গ্রে কোড জেনারেট করো এবং শুধু সেই কোডগুলো রাখো যেগুলোতে $K$টি $1$ আছে।
...
প্রথমে, আমরা প্রুফ করি যে প্রথম এবং শেষ মাস্ক ঠিক দুটি বিটে ভিন্ন। এটাকরতে, লক্ষ্য করাই যথেষ্ট যে $G(N)$ ক্রমের প্রথম মাস্কটি হবে $N-K$টি $0$, তারপর $K$টি $1$। যেহেতু প্রথম বিটটি $0$ হিসেবে সেট করা, তারপর $(N-K-1)$টি $0$, তারপর $K$টি সেট বিট আসে এবং শেষ মাস্কটি হবে $1$, তারপর $(N-K)$টি $0$, তারপর $K-1$টি $1$।
ম্যাথমেটিক্যাল ইন্ডাকশন নীতি প্রয়োগ করে এবং $G(N)$-এর সূত্র ব্যবহার করে প্রুফ সম্পূর্ণ হয়।
...
$O\left(N \cdot \binom{N}{K}\right)$-এ কাজ করে, তবে এটাপ্রকৃতিতে রিকার্সিভ এবং $N$-এর ছোট মানের জন্য সম্ভবত আগের সমাধানের চেয়ে বড় ধ্রুবক আছে।
