---
title: "স্ট্রিং ম্যাচিং-এর জন্য রবিন-কার্প অ্যালগরিদম"
tags: 
weight: 20
---
# স্ট্রিং ম্যাচিং-এর জন্য রবিন-কার্প অ্যালগরিদম

এই অ্যালগরিদমটি হ্যাশিং-এর ধারণার উপর ভিত্তি করে তৈরি, তাই তুমি যদি স্ট্রিং হ্যাশিং-এর সাথে পরিচিত না হও, তাহলে [স্ট্রিং হ্যাশিং](string-hashing.md) আর্টিকেলটা দেখো।

এই অ্যালগরিদমটি ১৯৮৭ সালে রবিন এবং কার্প প্রণয়ন করেন।

সমস্যা: দুটি স্ট্রিং দেওয়া আছে - একটি প্যাটার্ন $s$ এবং একটি টেক্সট $t$, প্যাটার্নটি টেক্সটে আছে কিনা তা নির্ণয় করো এবং থাকলে $O(|s| + |t|)$ সময়ে এর সকল অবস্থান গণনা করো।

অ্যালগরিদম: প্যাটার্ন $s$-এর হ্যাশ গণনা করো।
টেক্সট $t$-এর সকল প্রিফিক্সের হ্যাশ মান গণনা করো।
এখন, আমরা গণনাকৃত হ্যাশ ব্যবহার করে $|s|$ দৈর্ঘ্যের একটি সাবস্ট্রিংকে $s$-এর সাথে ধ্রুব সময়ে তুলনা করতে পারি।
সুতরাং, $|s|$ দৈর্ঘ্যের প্রতিটি সাবস্ট্রিংকে প্যাটার্নের সাথে তুলনা করো। এতে মোট $O(|t|)$ সময় লাগবে।
