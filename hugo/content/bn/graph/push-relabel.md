---
title: "ম্যাক্সিমাম ফ্লো - পুশ-রিলেবেল অ্যালগরিদম"
tags: 
weight: 20
---
...
আমরা যে সমস্যা সমাধান করতে চাই তার সোজা সংজ্ঞা [ম্যাক্সিমাম ফ্লো - ফোর্ড-ফুলকারসন ও এডমন্ডস-কার্প](edmonds_karp.md) আর্টিকেলে পাওয়া যাবে।

এই আর্টিকেলে আমরা নেটওয়ার্কের মধ্য দিয়ে একটি প্রিফ্লো পুশ করে সমস্যা সমাধান করব, যেটি $O(V^4)$, বা আরো সোজা কথায় $O(V^2 E)$ সময়ে চলবে।
...
একটি গুরুত্বপূর্ণ বিষয় লক্ষ্য কর, যদি একটি ভ্যালিড লেবেলিং ফাংশন বিদ্যমান থাকে, তাহলে রেসিডুয়াল গ্রাফে $s$ থেকে $t$-তে কোনো অগমেন্টিং পাথ থাকে না।
...
তারপর যদি অ্যালগরিদম ডিটারমিন করে, প্রিফ্লোটি একটি ভ্যালিড ফ্লো।
...
এখন চলো দুটি অপারেশন আরো বিস্তারিতভাবে বর্ণনা করি।
