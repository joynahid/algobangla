...
ধরো দুইজন খেলোয়াড় একটা যেকোনো গ্রাফ $G$-তে একটা গেম খেলছে।
মানে গেমের বর্তমান অবস্থা একটা নির্দিষ্ট ভার্টেক্স (vertex)।
...
আমরা সবচেয়ে সাধারণ ক্ষেত্র কনসিডার করি, সাইকেলসহ একটি যেকোনো ডিরেক্টেড গ্রাফের ক্ষেত্র।
আমাদের কাজ হলো, দেওয়া একটি প্রারম্ভিক অবস্থায়, ডিটারমিন করা যে উভয় খেলোয়াড় অপটিমাল কৌশলে খেললে কে জিতবে, অথবা গেমের ফলাফল ড্র হবে কিনা।
...
এছাড়াও আমাদের নিচের **নিয়মগুলো** আছে:
...
তাহলে, আমরা তৎক্ষণাৎ $O(n m)$ সময়ে চলে এমন একটা অ্যালগরিদম ডিফাইন করতে পারি।
আমরা সব ভার্টেক্সের মধ্য দিয়ে যাই এবং প্রথম বা দ্বিতীয় নিয়ম প্রয়োগের চেষ্টা করি, এবং রিপিট করি।

তবে, আমরা এই প্রক্রিয়াটাকে আরও ফাস্ট করতে পারি, এবং কমপ্লেক্সিটি $O(m)$-এ নামিয়ে আনতে পারি।

আমরা সেই সব ভার্টেক্সের উপর দিয়ে যাব, যেগুলো শুরুতে জয়ী বা পরাজিত অবস্থা বলে জানি।
এদের প্রতিটি থেকে, আমরা একটি [DFS](../graph/depth-first-search.md) শুরু করব।
...
আমরা ধরে নিচ্ছি যে `adj_rev` ভেরিয়েবলে গ্রাফের **বিপরীত** আকারে অ্যাডজেসেন্সি লিস্ট স্টোর করা, অর্থাৎ গ্রাফের এজ $(i, j)$ সংরক্ষণের বদলে, আমরা $(j, i)$ সংরক্ষণ করি।
...
এর জন্য আমাদের গেমের নিয়মগুলো ফর্মালি প্রকাশ করতে হবে।
...
এরপর আমাদের ডিটারমিন করতে হবে কোন ভার্টেক্সগুলো শুরুতে জয়ী এবং কোনগুলো পরাজিত।
...
ইমপ্লিমেন্টের আগে একটা মাত্র বিষয় সিদ্ধান্ত নিতে হবে যে তুমি গ্রাফটা **এক্সপ্লিসিটলি** (explicitly) তৈরি করতে চাও নাকি **অন-দ্য-ফ্লাই** (on the fly) তৈরি করতে চাও।
একদিকে, এক্সপ্লিসিটলি গ্রাফ তৈরি করা অনেক সহজ এবং ভুলের সম্ভাবনা কম।
অন্যদিকে, এটা কোডের পরিমাণ বাড়াবে এবং রানিং টাইম অন-দ্য-ফ্লাই তৈরির তুলনায় ধীর হবে।

নিচের ইমপ্লিমেন্টেশন এক্সপ্লিসিটলি গ্রাফ তৈরি করবে:
