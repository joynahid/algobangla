...
- একটা এলাকা (যেমন দাবার বোর্ড/গ্রিড) কিছু চিত্র (যেমন ডমিনো) দিয়ে সম্পূর্ণভাবে পূরণ করার উপায়ের সংখ্যা বের করা
- ন্যূনতম সংখ্যক চিত্র দিয়ে একটা এলাকা পূরণ করার উপায় বের করা
...
**সমস্যার বিবরণ।** $N \times M$ আকারের একটা গ্রিড দেওয়া আছে। $2 \times 1$ আকারের চিত্র দিয়ে গ্রিডটা পূরণ করার উপায়ের সংখ্যা বের করো (কোনো ঘর খালি থাকবে না, এবং চিত্রগুলো একে অপরের উপর ওভারল্যাপ করবে না)।

ধরো ডিপি স্টেট হলো: $dp[i, mask]$, যেখানে $i = 1, \ldots N$ এবং $mask = 0, \ldots 2^M - 1$।

$i$ বর্তমান গ্রিডের সারির সংখ্যা রিপ্রেজেন্ট করে, এবং $mask$ হলো বর্তমান গ্রিডের শেষ সারির অবস্থা। যদি $mask$-এর $j$-তম বিট $0$ হয় তাহলে সংশ্লিষ্ট ঘরটা পূরণ করা হয়েছে, নাহলে এটা পূরণ হয়নি।

স্পষ্টতই, সমস্যার উত্তর হবে $dp[N, 0]$।

আমরা প্রতিটা $i = 1, \cdots N$ এবং প্রতিটা $mask = 0, \ldots 2^M - 1$ এর উপর ইটারেট করে ডিপি স্টেট তৈরি করব, এবং প্রতিটা $mask$-এর জন্য আমরা শুধুমাত্র সামনের দিকে ট্রানজিশন করব, মানে বর্তমান গ্রিডে চিত্র _যোগ_ করব।
