---
title: "ক্যাটালান সংখ্যা"
tags: 
weight: 30
---
# ক্যাটালান সংখ্যা
ক্যাটালান সংখ্যা হলো একটি সংখ্যা ক্রম, যা বিভিন্ন কম্বিনেটরিক্স সমস্যায় কাজে আসে, বিশেষ করে যেসব সমস্যায় রিকার্সিভভাবে ডিফাইন করা অবজেক্ট জড়িত থাকে।

এই ক্রমটি বেলজিয়ান গণিতবিদ [Catalan](https://en.wikipedia.org/wiki/Eug%C3%A8ne_Charles_Catalan)-এর নামে নামকরণ করা হয়েছে, যিনি ১৯শ শতকে জীবিত ছিলেন। (আসলে ক্যাটালানের এক শতক আগে অয়লারের কাছে এটাপরিচিত ছিল)।
...
ক্যাটালান সংখ্যা $C_n$ হলো নিচের সমস্যাগুলোর সমাধান:
...
ক্যাটালান সংখ্যার দুটি সূত্র আছে: **রিকার্সিভ এবং বিশ্লেষণাত্মক**। যেহেতু আমরা বিশ্বাস করি যে উপরে উল্লেখিত সব সমস্যা সমতুল্য (একই সমাধান আছে), তাই নিচের সূত্রগুলোর প্রুফের জন্য আমরা এমন সমস্যা বেছে নেব যেটা সবচেয়ে সহজ।
...
তুমি এটাএভাবেও চিন্তা করতে পারেন। সংজ্ঞা অনুসারে, $C_n$ সঠিক ব্র্যাকেট সিকোয়েন্সের সংখ্যা বোঝায়। এখন, সিকোয়েন্সটিকে $k$ এবং ${n - k}$ দৈর্ঘ্যের ২টি অংশে ভাগ করা যায়, যার প্রতিটি একটি সঠিক ব্র্যাকেট সিকোয়েন্স হওয়া উচিত। উদাহরণ:
...
(এখানে $\binom{n}{k}$ হলো সাধারণ বাইনোমিয়াল কোএফিশিয়েন্ট, অর্থাৎ $n$টি অবজেক্ট থেকে $k$টি অবজেক্ট বাছাই করার উপায়ের সংখ্যা)।
...
এখন আমরা সেই মনোটনিক পাথের সংখ্যা গুনব যেগুলো মূল কর্ণ অতিক্রম করে। এমন পাথগুলো কনসিডার করি যেগুলো মূল কর্ণ অতিক্রম করে এবং এর মধ্যে প্রথম এজটি খুঁজে বের করি যেটা কর্ণের উপরে। এই এজের পর থেকে বাকি পাথটি কর্ণের সাপেক্ষে প্রতিফলিত করি। ফলাফল সবসময় $(n - 1) \times (n + 1)$ গ্রিডে একটি মনোটনিক পাথ হয়। অন্যদিকে, $(n - 1) \times (n + 1)$ ল্যাটিসে যেকোনো মনোটনিক পাথ অবশ্যই কর্ণকে ছেদ করবে। অতএব, আমরা $n \times n$ ল্যাটিসে মূল কর্ণ অতিক্রমকারী সব মনোটনিক পাথ গুনে ফেলেছি।
