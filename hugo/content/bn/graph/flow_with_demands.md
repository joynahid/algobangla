...
এটি সাধারণ ফ্লো সমস্যার একটি সাধারণীকরণ, কারণ সমস্ত এজ $e$-এর জন্য $d(e) = 0$ সেট করলে একটি সাধারণ ফ্লো নেটওয়ার্ক পাওয়া যায়। লক্ষ্য কর যে, সাধারণ ফ্লো নেটওয়ার্কে একটি বৈধ ফ্লো খুঁজে পাওয়া অত্যন্ত সহজ, শুধু $f(e) = 0$ সেট করলেই একটি বৈধ ফ্লো হয়। তবে প্রতিটি এজের ফ্লো যদি একটি ডিমান্ড পূরণ করতে হয়, তাহলে হঠাৎ করেই একটি বৈধ ফ্লো খুঁজে পাওয়া বেশ জটিল হয়ে পড়ে।

আমরা দুটি সমস্যা কনসিডার করব:
...
আমরা নেটওয়ার্কে নিম্নলিখিত পরিবর্তন করি। একটি নতুন সোর্স $s'$ এবং একটি নতুন সিংক $t'$, সোর্স $s'$ থেকে প্রতিটি অন্য ভার্টেক্সে একটি নতুন এজ, প্রতিটি ভার্টেক্স থেকে সিংক $t'$-এ একটি নতুন এজ, এবং $t$ থেকে $s$-তে একটি এজ যোগ করি। এছাড়াও আমরা নতুন ক্যাপাসিটি ফাংশন $c'$ এভাবে ডিফাইন করি:
