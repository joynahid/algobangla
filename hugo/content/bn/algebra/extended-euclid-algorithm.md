...
এটা গুরুত্বপূর্ণ যে [বেজুর অভেদ](https://en.wikipedia.org/wiki/B%C3%A9zout%27s_identity) অনুযায়ী আমরা সর্বদা এমন একটি উপস্থাপনা খুঁজে পেতে পারি। উদাহরণস্বরূপ, $\gcd(55, 80) = 5$, তাই আমরা $5$ কে $55$ এবং $80$ পদবিশিষ্ট একটি রৈখিক সমন্বয় হিসেবে উপস্থাপন করতে পারি: $55 \cdot 3 + 80 \cdot (-2) = 5$

এই সমস্যার একটি আরও সাধারণ রূপ [রৈখিক ডায়োফ্যান্টাইন ইকুয়েশন](linear-diophantine-equation.md) সম্পর্কিত আর্টিকেলে আলোচনা করা হয়েছে।
এটা এই অ্যালগরিদমের উপর ভিত্তি করে তৈরি হবে।
...
আমরা যদি অ্যালগরিদমটা স্মরণ করি, দেখতে পাব যে অ্যালগরিদমটা $b = 0$ এবং $a = g$ দিয়ে শেষ হয়।
...
$(x_1, y_1)$-এর সহগ ইকুয়েশনে এই এক্সপ্রেশন প্রতিস্থাপন করলে পাই:
...
যেহেতু এটা রিকার্সন এড়ায়, কোডটা রিকার্সিভটার চেয়ে একটু দ্রুত চলবে।
...
তুমি যদি `a1` ও `b1` ভেরিয়েবলগুলো ভালো করে দেখো, লক্ষ্য করবে যে তারা স্বাভাবিক [ইউক্লিডীয় অ্যালগরিদমের](euclid-algorithm.md#implementation) ইটারেটিভ ভার্সনে ঠিক একই মান নেয়। তাই অ্যালগরিদম অন্তত সঠিক GCD গণনা করবে।
...
ধরি একটি ইটারেশনের শেষে মানগুলো প্রাইম ($'$) দ্বারা চিহ্নিত, এবং ধরো $q = \frac{a_1}{b_1}$। [ইউক্লিডীয় অ্যালগরিদম](euclid-algorithm.md) থেকে, আমরা পাই:

$$a_1' = b_1$$

$$b_1' = a_1 - q \cdot b_1$$

প্রথম ইনভেরিয়েন্ট ধরে রাখতে, নিচেরটা সত্য হওয়া উচিত:

$$x' \cdot a + y' \cdot b = a_1' = b_1$$

$$x' \cdot a + y' \cdot b = x_1 \cdot a + y_1 \cdot b$$

একইভাবে দ্বিতীয় ইনভেরিয়েন্টের জন্য, নিচেরটা ধরে রাখা উচিত:

$$x_1' \cdot a + y_1' \cdot b = a_1 - q \cdot b_1$$

$$x_1' \cdot a + y_1' \cdot b = (x - q \cdot x_1) \cdot a + (y - q \cdot y_1) \cdot b$$

$a$ ও $b$-এর সহগ তুলনা করে, প্রতিটি ভেরিয়েবলের আপডেট ইকুয়েশন বের করা যায়, যা নিশ্চিত করে যে ইনভেরিয়েন্টগুলো সমগ্র অ্যালগরিদম জুড়ে বজায় থাকে।


শেষে আমরা জানি $a_1$-এ GCD আছে, তাই $x \cdot a + y \cdot b = g$।
যার মানে আমরা প্রয়োজনীয় সহগ খুঁজে পেয়েছি।

তুমি কোড আরও অপটিমাইজ করতে পারো, এবং কোড থেকে $a_1$ ও $b_1$ ভেরিয়েবল সরিয়ে $a$ ও $b$ পুনর্ব্যবহার করতে পারো।
তবে এটা করলে, ইনভেরিয়েন্ট নিয়ে যুক্তি দেওয়ার ক্ষমতা হারাবে।
