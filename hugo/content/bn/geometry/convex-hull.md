...
$N$ টি বিন্দু সমতলে দেওয়া আছে, আর লক্ষ্য হলো একটা কনভেক্স হাল (convex hull) তৈরি করা। মানে সবচেয়ে ছোট
কনভেক্স পলিগন যেটা সবগুলো দেওয়া বিন্দু ধারণ করে।
...
$\mathcal{O}(N \log N)$, এবং অ্যাসিম্পটোটিকভাবে অপটিমাল (কারণ এটি প্রুফিত যে এর চেয়ে
...
অ্যালগরিদমটি প্রথমে সবচেয়ে নিচের বিন্দু $P_0$ খুঁজে বের করে। যদি একই Y স্থানাঙ্কে একাধিক বিন্দু থাকে, তাহলে ছোট X স্থানাঙ্কবিশিষ্ট বিন্দুটি কনসিডার করা হয়। এই
ধাপটি $\mathcal{O}(N)$ সময়ে কমপ্লিট হয়।
...
বিন্দু এবং এর আগের দুটি বিন্দু ঘড়ির কাঁটার দিকে বাঁক নেয়, অন্যথায় আগের
...
নাহলে তুমি সবচেয়ে ছোট কনভেক্স হাল পাবে না।
...
দেওয়া বিন্দুগুলোর কোনো জোড়ার রেখা দ্বারা ধারণ করা যায় না।
...
(যেটাকে আমরা B হিসেবে ডিফাইন করেছি) কিনা, অথবা A ও বর্তমান বিন্দুর রেখা এবং বর্তমান বিন্দু ও B-র রেখার মধ্যবর্তী অরিয়েন্টেশন ঘড়ির কাঁটার দিকে কিনা। সেই ক্ষেত্রগুলোতে
...
দেওয়া বিন্দু উপরের সেটে থাকলে, আমরা উপরের কনভেক্স হালের দ্বিতীয় শেষ ও শেষ বিন্দু সংযোগকারী রেখা এবং
শেষ বিন্দু ও বর্তমান বিন্দু সংযোগকারী রেখার দ্বারা গঠিত কোণ পরীক্ষা করি। যদি কোণটি ঘড়ির কাঁটার দিকে না হয়, তাহলে উপরের কনভেক্স হালে সবশেষে যোগ করা বিন্দুটি সরিয়ে দিই কারণ বর্তমান বিন্দু কনভেক্স হালে যোগ হলে আগের বিন্দুটি ধারণ করতে পারবে।
...
দেওয়া বিন্দু নিচের সেটে থাকলে, আমরা উপরের সেটের বিন্দুর মতোই কাজ করি শুধু ঘড়ির কাঁটার দিকের পরিবর্তে ঘড়ির কাঁটার বিপরীত অরিয়েন্টেশন পরীক্ষা করি। সুতরাং, নিচের কনভেক্স হালের দ্বিতীয় শেষ ও শেষ বিন্দু সংযোগকারী রেখা এবং
...
কলিনিয়ার (collinear) বিন্দু দরকার হলে, CW/CCW রুটিনে সেগুলো চেক করতে হবে।
তবে, এটা একটা ডিজেনারেট কেস অনুমতি দেয় যেখানে সব ইনপুট বিন্দু একটা রেখায় কলিনিয়ার, আর অ্যালগরিদম ডুপ্লিকেট বিন্দু আউটপুট করবে।
এটা ফিক্স করতে, আমরা চেক করি উপরের হালে সব বিন্দু আছে কিনা। থাকলে বিন্দুগুলো রিভার্স করে রিটার্ন করি, কারণ
গ্রাহাম ইমপ্লিমেন্টেশন এই কেসে তাই রিটার্ন করবে।
