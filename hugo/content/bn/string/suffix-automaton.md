...
উদাহরণস্বরূপ, তুমি একটি স্ট্রিং-এ অন্য একটি স্ট্রিং-এর সমস্ত ঘটনা খুঁজে পেতে পারো, বা দেওয়া স্ট্রিং-এর বিভিন্ন সাবস্ট্রিং-এর সংখ্যা গণনা করতে পারো।
উভয় কাজই একটি সাফিক্স অটোমেটন-এর সাহায্যে লিনিয়ার সময়ে সমাধান করা যায়।

স্বজ্ঞাগতভাবে একটি সাফিক্স অটোমেটন দেওয়া স্ট্রিং-এর **সমস্ত সাবস্ট্রিং**-এর একটি সংকুচিত ফর্ম হিসাবে বোঝা যায়।
একটি চিত্তাকর্ষক সত্য হল যে সাফিক্স অটোমেটন এই সমস্ত তথ্য অত্যন্ত সংকুচিত আকারে রয়েছে।
দৈর্ঘ্য $n$ এর একটি স্ট্রিং-এর জন্য এটা শুধুমাত্র $O(n)$ মেমরি প্রয়োজন।
অধিকন্তু, এটা $O(n)$ সময়ে নির্মিত হতে পারে (যদি আমরা বর্ণমালার আকার $k$ একটি ধ্রুবক হিসাবে কনসিডার করি), অন্যথায় মেমরি এবং সময় উভয় কমপ্লেক্সিটি $O(n \log k)$ হবে।
...
দেওয়া স্ট্রিং $s$ এর জন্য একটি সাফিক্স অটোমেটন একটি ন্যূনতম **DFA** (নির্ধারক সীমিত অটোমেটন / নির্ধারক সীমিত স্টেট মেশিন) যা স্ট্রিং $s$ এর সমস্ত সাফিক্স গ্রহণ করে।

অন্য কথায়:

 -  একটি সাফিক্স অটোমেটন একটি ভিত্তিক অ্যাসাইক্লিক গ্রাফ।
    ভার্টেক্সগুলোকে **স্টেট** বলা হয়, এবং এজগুলিকে স্টেট-এর মধ্যে **ট্রানজিশন** বলা হয়।
 -  একটি স্টেট $t_0$ হলো **প্রাথমিক স্টেট**, এবং এটা অবশ্যই গ্রাফের উৎস হতে হবে (অন্যান্য সমস্ত স্টেট $t_0$ থেকে পৌঁছানো যায়)।
...
![Suffix automaton for ""](/images/string/SA.png)

For the string $s =~ \text{"a"}$:

![Suffix automaton for "a"](/images/string/SAa.png)

For the string $s =~ \text{"aa"}$:

![Suffix automaton for "aa"](/images/string/SAaa.png)

For the string $s =~ \text{"ab"}$:

![Suffix automaton for "ab"](/images/string/SAab.png)

For the string $s =~ \text{"aba"}$:

![Suffix automaton for "aba"](/images/string/SAaba.png)

For the string $s =~ \text{"abb"}$:

![Suffix automaton for "abb"](/images/string/SAabb.png)

For the string $s =~ \text{"abbb"}$:

![Suffix automaton for "abbb"](/images/string/SAabbb.png)
...
![Suffix automaton for "abcbc" with suffix links](/images/string/SA_suffix_links.png)
