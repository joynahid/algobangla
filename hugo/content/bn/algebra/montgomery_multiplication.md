...
গুণফল ভাগ করে $n$ একাধিকবার বিয়োগ করার বদলে, এটা নিচের বিটগুলো বাতিল করতে $n$-এর গুণিতক যোগ করে এবং তারপর নিচের বিটগুলো বাদ দেয়।
...
মন্টগোমেরি স্পেসে একটি সংখ্যা $x$-এর প্রতিনিধি $\bar{x}$ এভাবে ডিফাইন করা:

$$\bar{x} := x \cdot r \bmod n$$

লক্ষ্য কর, রূপান্তরটি আসলে সেই ধরনের গুণনই যা আমরা অপটিমাইজ করতে চাই।
তাই এটা এখনও একটি ব্যয়বহুল অপারেশন।
তবে তোমাকে একটি সংখ্যাকে কেবল একবার স্পেসে রূপান্তর করতে হবে।
মন্টগোমেরি স্পেসে থাকলে, তুমি দক্ষতার সাথে যত খুশি অপারেশন করতে পারেন।
এবং শেষে চূড়ান্ত ফলাফলটিকে আবার রূপান্তর করেন।
তাই যতক্ষণ তুমি $n$ মডুলোতে অনেক অপারেশন করছেন, এটা কোনো সমস্যা নয়।

মন্টগোমেরি স্পেসের ভিতরে তুমি এখনও বেশিরভাগ অপারেশন স্বাভাবিকভাবে করতে পারেন।
...
তবে গুণনের ক্ষেত্রে এটা প্রযোজ্য নয়।
...
তাই মন্টগোমেরি স্পেসে গুণন এভাবে ডিফাইন করা:
...
এই অপারেশনকে **মন্টগোমেরি রিডাকশন** বলা হয়, এবং এটা **REDC** অ্যালগরিদম হিসেবেও পরিচিত।
...
এটা আমাদের $x \cdot r^{-1} \bmod n$ গণনার নিচের অ্যালগরিদম দেয়:
...
ইনভার্স $n^{\prime} := n^{-1} \bmod r$ দক্ষতার সাথে গণনা করতে, আমরা নিচের ট্রিক ব্যবহার করতে পারি (যা নিউটনের পদ্ধতি থেকে অনুপ্রাণিত):

$$a \cdot x \equiv 1 \bmod 2^k \Longrightarrow a \cdot x \cdot (2 - a \cdot x) \equiv 1 \bmod 2^{2k}$$

এটা সহজেই প্রুফ করা যায়।
...
নিচের কোডে আমরা `r2`-কে `-n % n` দিয়ে ইনিশিয়ালাইজ করি, যা $r - n \equiv r \bmod n$-এর সমতুল্য, এটিকে ৪ বার শিফট করে $r \cdot 2^4 \bmod n$ পাই।
