...
weight: 10
---
# Lowest Common Ancestor (LCA) - $O(\sqrt{N})$ এবং $O(\log N)$, $O(N)$ প্রিপ্রসেসিং সহ

একটি ট্রি $G$ দেওয়া আছে। $(v_1, v_2)$ আকারের কুয়েরি দেওয়া আছে, প্রতিটি কুয়েরির জন্য LCA বের করতে হবে, অর্থাৎ এমন একটি ভার্টেক্স $v$ বের করতে হবে যেটি রুট থেকে $v_1$ পর্যন্ত পাথে এবং রুট থেকে $v_2$ পর্যন্ত পাথে অবস্থিত, এবং ভার্টেক্সটি সবচেয়ে নিচে হতে হবে। অন্যভাবে বলতে গেলে, কাঙ্ক্ষিত ভার্টেক্স $v$ হলো $v_1$ এবং $v_2$-এর সবচেয়ে নিচের অ্যানসেস্টর। এটা স্পষ্ট যে তাদের LCA $v_1$ এবং $v_2$-এর মধ্যকার শর্টেস্ট পাথে অবস্থিত। এছাড়াও, যদি $v_1$ হয় $v_2$-এর অ্যানসেস্টর, তাহলে $v_1$ হলো তাদের LCA।
...
অয়লার ট্যুরে $v_1$-এর প্রথম ভিজিট এবং $v_2$-এর প্রথম ভিজিটের মধ্যে যে ভার্টেক্সগুলো আমরা ভিজিট করি তাদের কনসিডার করি।
সহজেই দেখা যায় যে, $\text{LCA}(v_1, v_2)$ হলো এই পাথে সবচেয়ে কম উচ্চতার ভার্টেক্স।
আমরা ইতোমধ্যে লক্ষ্য করেছি যে, LCA অবশ্যই $v_1$ এবং $v_2$-এর মধ্যকার শর্টেস্ট পাথের অংশ হবে।
...
কিন্তু এই সাবট্রিগুলোর সব ভার্টেক্স LCA-র চেয়ে নিচে অবস্থিত এবং তাই তাদের উচ্চতা বেশি।
সুতরাং $\text{LCA}(v_1, v_2)$ অনন্যভাবে ডিটারমিন করা যায় অয়লার ট্যুরে $\text{first}(v_1)$ এবং $\text{first}(v_2)$-এর মধ্যে সবচেয়ে কম উচ্চতার ভার্টেক্স খুঁজে।

চলো এই ধারণাটি চিত্রিত করি।
নিচের গ্রাফ এবং সংশ্লিষ্ট উচ্চতাসহ অয়লার ট্যুর কনসিডার করো:
...
এভাবে, **LCA সমস্যাটি RMQ সমস্যায় রিডিউস হয়ে যায়** (একটি রেঞ্জে মিনিমাম বের করার সমস্যা)।
...
যেহেতু স্টোর করা মানগুলোতে আপডেট প্রায় কখনোই হবে না, তাই [স্পার্স টেবিল](../data_structures/sparse-table.md) একটি ভালো পছন্দ হতে পারে, যেটি $O(N\log N)$ বিল্ড সময়ে $O(1)$ কুয়েরি উত্তর দিতে পারে।

### ইমপ্লিমেন্টেশন

LCA অ্যালগরিদমের নিচের ইমপ্লিমেন্টেশনে একটি সেগমেন্ট ট্রি ব্যবহার করা হয়েছে।
