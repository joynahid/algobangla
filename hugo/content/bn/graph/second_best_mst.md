---
title: "দ্বিতীয় সেরা মিনিমাম স্প্যানিং ট্রি"
tags: 
weight: 40
---
# দ্বিতীয় সেরা মিনিমাম স্প্যানিং ট্রি

একটি মিনিমাম স্প্যানিং ট্রি $T$ হলো দেওয়া গ্রাফ $G$-এর জন্য এমন একটি ট্রি যেটি দেওয়া গ্রাফের সব ভার্টেক্সকে সংযুক্ত করে এবং সব সম্ভাব্য স্প্যানিং ট্রি-র মধ্যে সব এজের ওয়েট যোগফল সর্বনিম্ন।
...
পর্যবেক্ষণ করা যায় যে, দ্বিতীয় সেরা মিনিমাম স্প্যানিং ট্রি $T$ থেকে শুধুমাত্র একটি এজ প্রতিস্থাপনে পার্থক্য করে। (এই স্টেটমেন্টর প্রুফের জন্য [এখানে](http://www-bcf.usc.edu/~shanghua/teaching/Spring2010/public_html/files/HW2_Solutions_A.pdf) সমস্যা ২৩-১ দেখুন)।
...
লক্ষ্য কর: ধাপ ৩-এর জন্য আমাদের এজগুলো আবার সর্ট করার দরকার নেই।

সুতরাং, সামগ্রিক টাইম কমপ্লেক্সিটি হবে $O(E \log V + E + V E)$ = $O(V E)$।


## Lowest Common Ancestor (LCA) সমস্যায় মডেলিং
...
১. এজগুলো $O(E \log E)$-এ সর্ট করি, তারপর ক্রুস্কাল দিয়ে $O(E)$-এ এমএসটি বের করি।
২. প্রতিটি এজ $e$ যেটি ইতোমধ্যে এমএসটি-তে নেই, সেটিকে সাময়িকভাবে এমএসটি-তে যোগ করি, একটি সাইকেল তৈরি করি। সাইকেলটি LCA দিয়ে যাবে।
৩. সাইকেলে $e$-এর সমান নয় এমন সর্বোচ্চ ওয়েটের এজ $k$ খুঁজি, $e$ এজের নোডগুলোর প্যারেন্ট ধরে LCA পর্যন্ত গিয়ে।
...
$O(E \log V)$-এ দক্ষতার সাথে গণনা করার একটি উপায় হলো সমস্যাটিকে LCA সমস্যায় রূপান্তর করা।

আমরা এমএসটি-কে রুট করে LCA প্রিপ্রসেস করব এবং তাদের অ্যানসেস্টরদের পাথে সর্বোচ্চ এজ ওয়েটও গণনা করব।
এটি LCA-র জন্য [বাইনারি লিফটিং](lca_binary_lifting.md) ব্যবহার করে করা যায়।
...
<div style="text-align: center;">
  <img src="/images/graph/second_best_mst_1.png" alt="MST">
  <img src="/images/graph/second_best_mst_2.png" alt="Second best MST">
  <br />
...
দেওয়া গ্রাফে ধরি আমরা উপরের নীল ভার্টেক্সে এমএসটি রুট করি, তারপর এমএসটি-তে নেই এমন এজগুলো বেছে নিয়ে আমাদের অ্যালগরিদম চালাই।
...
লক্ষ্য কর: $\text{LCA}(u, v)$ কিছু ক্ষেত্রে $u$ বা $v$-এর সমানও হতে পারে।
